...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function fp(i,e,t){const n=new Float32Array(ni),s=new U(0,1,0);return new mn({name:"SphericalGaussianBlur",defines:{n:ni,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:dr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function ll(){return new mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function cl(){return new mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dr(),fragmentShader:`
	...
	`}class xc extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new dc(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new kn(5,5,5),r=new mn({name:"CubemapFromEquirect",uniforms:ki(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Nt,blending:wn});r.uniforms.tEquirect.value=t;const a=new Ft(s,r),o=t.minFilter;return t.minFilter===ii&&(t.minFilter=Ct),new xu(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function pp(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,m=!1){return h==null?null:m?a(h):r(h)}function r(h){if(h&&h.isTexture){const m=h.mapping;if(m===_r||m===gr)if(e.has(h)){const _=e.get(h).texture;return o(_,h.mapping)}else{const _=h.image;if(_&&_.height>0){const x=new xc(_.height);return x.fromEquirectangularTexture(i,h),e.set(h,x),h.addEventListener("dispose",c),o(x.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const m=h.mapping,_=m===_r||m===gr,x=m===ui||m===Vi;if(_||x){let f=t.get(h);const d=f!==void 0?f.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==d)return n===null&&(n=new al(i)),f=_?n.fromEquirectangular(h,f):n.fromCubemap(h,f),f.texture.pmremVersion=h.pmremVersion,t.set(h,f),f.texture;if(f!==void 0)return f.texture;{const S=h.image;return _&&S&&S.height>0||x&&S&&l(S)?(n===null&&(n=new al(i)),f=_?n.fromEquirectangular(h):n.fromCubemap(h),f.texture.pmremVersion=h.pmremVersion,t.set(h,f),h.addEventListener("dispose",u),f.texture):null}}}return h}function o(h,m){return m===_r?h.mapping=ui:m===gr&&(h.mapping=Vi),h}function l(h){let m=0;const _=6;for(let x=0;x<_;x++)h[x]!==void 0&&m++;return m===_}function c(h){const m=h.target;m.removeEventListener("dispose",c);const _=e.get(m);_!==void 0&&(e.delete(m),_.dispose())}function u(h){const m=h.target;m.removeEventListener("dispose",u);const _=t.get(m);_!==void 0&&(t.delete(m),_.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:p}}function mp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&or("WebGLRenderer: "+n+" extension not supported."),s}}}function _p(i,e,t,n){const s={},r=new WeakMap;function a(p){const h=p.target;h.index!==null&&e.remove(h.index);for(const _ in h.attributes)e.remove(h.attributes[_]);h.removeEventListener("dispose",a),delete s[h.id];const m=r.get(h);m&&(e.remove(m),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(p,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(p){const h=p.attributes;for(const m in h)e.update(h[m],i.ARRAY_BUFFER)}function c(p){const h=[],m=p.index,_=p.attributes.position;let x=0;if(_===void 0)return;if(m!==null){const S=m.array;x=m.version;for(let T=0,E=S.length;T<E;T+=3){const R=S[T+0],A=S[T+1],P=S[T+2];h.push(R,A,A,P,P,R)}}else{const S=_.array;x=_.version;for(let T=0,E=S.length/3-1;T<E;T+=3){const R=T+0,A=T+1,P=T+2;h.push(R,A,A,P,P,R)}}const f=new(_.count>=65535?lc:oc)(h,1);f.version=x;const d=r.get(p);d&&e.remove(d),r.set(p,f)}function u(p){const h=r.get(p);if(h){const m=p.index;m!==null&&h.version<m.version&&c(p)}else c(p);return r.get(p)}return{get:o,update:l,getWireframeAttribute:u}}function gp(i,e,t){let n;function s(h){n=h}let r,a;function o(h){r=h.type,a=h.bytesPerElement}function l(h,m){i.drawElements(n,m,r,h*a),t.update(m,n,1)}function c(h,m,_){_!==0&&(i.drawElementsInstanced(n,m,r,h*a,_),t.update(m,n,_))}function u(h,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,h,0,_);let f=0;for(let d=0;d<_;d++)f+=m[d];t.update(f,n,1)}function p(h,m,_,x){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let d=0;d<h.length;d++)c(h[d]/a,m[d],x[d]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,r,h,0,x,0,_);let d=0;for(let S=0;S<_;S++)d+=m[S]*x[S];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=p}function xp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Xe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function vp(i,e,t){const n=new WeakMap,s=new ct;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==p){let X=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",X)};var m=X;h!==void 0&&h.texture.dispose();const _=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,f=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let E=0;_===!0&&(E=1),x===!0&&(E=2),f===!0&&(E=3);let R=o.attributes.position.count*E,A=1;R>e.maxTextureSize&&(A=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const P=new Float32Array(R*A*4*p),v=new ic(P,R,A,p);v.type=$t,v.needsUpdate=!0;const y=E*4;for(let w=0;w<p;w++){const N=d[w],V=S[w],k=T[w],B=R*A*4*w;for(let G=0;G<N.count;G++){const F=G*y;_===!0&&(s.fromBufferAttribute(N,G),P[B+F+0]=s.x,P[B+F+1]=s.y,P[B+F+2]=s.z,P[B+F+3]=0),x===!0&&(s.fromBufferAttribute(V,G),P[B+F+4]=s.x,P[B+F+5]=s.y,P[B+F+6]=s.z,P[B+F+7]=0),f===!0&&(s.fromBufferAttribute(k,G),P[B+F+8]=s.x,P[B+F+9]=s.y,P[B+F+10]=s.z,P[B+F+11]=k.itemSize===4?s.w:1)}}h={count:p,texture:v,size:new Pe(R,A)},n.set(o,h),o.addEventListener("dispose",X)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let _=0;for(let f=0;f<c.length;f++)_+=c[f];const x=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Mp(i,e,t,n,s){let r=new WeakMap;function a(c){const u=s.render.frame,p=c.geometry,h=e.get(c,p);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const m=c.skeleton;r.get(m)!==u&&(m.update(),r.set(m,u))}return h}function o(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Sp={[Gl]:"LINEAR_TONE_MAPPING",[Hl]:"REINHARD_TONE_MAPPING",[kl]:"CINEON_TONE_MAPPING",[Wl]:"ACES_FILMIC_TONE_MAPPING",[Yl]:"AGX_TONE_MAPPING",[ql]:"NEUTRAL_TONE_MAPPING",[Xl]:"CUSTOM_TONE_MAPPING"};function yp(i,e,t,n,s){const r=new dn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new dn(e,t,{type:Cn,depthBuffer:!1,stencilBuffer:!1}),o=new en;o.setAttribute("position",new It([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new It([0,2,0,0,2,0],2));const l=new uu({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Ft(o,l),u=new uo(-1,1,1,-1,0,1);let p=null,h=null,m=!1,_,x=null,f=[],d=!1;this.setSize=function(S,T){r.setSize(S,T),a.setSize(S,T);for(let E=0;E<f.length;E++){const R=f[E];R.setSize&&R.setSize(S,T)}},this.setEffects=function(S){f=S,d=f.length>0&&f[0].isRenderPass===!0;const T=r.width,E=r.height;for(let R=0;R<f.length;R++){const A=f[R];A.setSize&&A.setSize(T,E)}},this.begin=function(S,T){if(m||S.toneMapping===un&&f.length===0)return!1;if(x=T,T!==null){const E=T.width,R=T.height;(r.width!==E||r.height!==R)&&this.setSize(E,R)}return d===!1&&S.setRenderTarget(r),_=S.toneMapping,S.toneMapping=un,!0},this.hasRenderPass=function(){return d},this.end=function(S,T){S.toneMapping=_,m=!0;let E=r,R=a;for(let A=0;A<f.length;A++){const P=f[A];if(P.enabled!==!1&&(P.render(S,R,E,T),P.needsSwap!==!1)){const v=E;E=R,R=v}}if(p!==S.outputColorSpace||h!==S.toneMapping){p=S.outputColorSpace,h=S.toneMapping,l.defines={},ke.getTransfer(p)===Ze&&(l.defines.SRGB_TRANSFER="");const A=Sp[h];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,S.setRenderTarget(x),S.render(c,u),x=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),l.dispose()}}const vc=new Pt,Ha=new fs(1,1),Mc=new ic,Sc=new kh,yc=new dc,hl=[],ul=[],dl=new Float32Array(16),fl=new Float32Array(9),pl=new Float32Array(4);function Yi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=hl[s];if(r===void 0&&(r=new Float32Array(s),hl[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function _t(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function gt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function fr(i,e){let t=ul[e];t===void 0&&(t=new Int32Array(e),ul[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Ep(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2fv(this.addr,e),gt(t,e)}}function Tp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;i.uniform3fv(this.addr,e),gt(t,e)}}function Ap(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4fv(this.addr,e),gt(t,e)}}function wp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),gt(t,e)}else{if(_t(t,n))return;pl.set(n),i.uniformMatrix2fv(this.addr,!1,pl),gt(t,n)}}function Rp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),gt(t,e)}else{if(_t(t,n))return;fl.set(n),i.uniformMatrix3fv(this.addr,!1,fl),gt(t,n)}}function Cp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),gt(t,e)}else{if(_t(t,n))return;dl.set(n),i.uniformMatrix4fv(this.addr,!1,dl),gt(t,n)}}function Pp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Dp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2iv(this.addr,e),gt(t,e)}}function Ip(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3iv(this.addr,e),gt(t,e)}}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4iv(this.addr,e),gt(t,e)}}function Up(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Np(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2uiv(this.addr,e),gt(t,e)}}function Fp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3uiv(this.addr,e),gt(t,e)}}function Op(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4uiv(this.addr,e),gt(t,e)}}function Bp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Ha.compareFunction=t.isReversedDepthBuffer()?ao:ro,r=Ha):r=vc,t.setTexture2D(e||r,s)}function zp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Sc,s)}function Vp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||yc,s)}function Gp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Mc,s)}function Hp(i){switch(i){case 5126:return Ep;case 35664:return bp;case 35665:return Tp;case 35666:return Ap;case 35674:return wp;case 35675:return Rp;case 35676:return Cp;case 5124:case 35670:return Pp;case 35667:case 35671:return Dp;case 35668:case 35672:return Ip;case 35669:case 35673:return Lp;case 5125:return Up;case 36294:return Np;case 36295:return Fp;case 36296:return Op;case 35678:case 36198:case 36298:case 36306:case 35682:return Bp;case 35679:case 36299:case 36307:return zp;case 35680:case 36300:case 36308:case 36293:return Vp;case 36289:case 36303:case 36311:case 36292:return Gp}}function kp(i,e){i.uniform1fv(this.addr,e)}function Wp(i,e){const t=Yi(e,this.size,2);i.uniform2fv(this.addr,t)}function Xp(i,e){const t=Yi(e,this.size,3);i.uniform3fv(this.addr,t)}function Yp(i,e){const t=Yi(e,this.size,4);i.uniform4fv(this.addr,t)}function qp(i,e){const t=Yi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Kp(i,e){const t=Yi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function jp(i,e){const t=Yi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Zp(i,e){i.uniform1iv(this.addr,e)}function $p(i,e){i.uniform2iv(this.addr,e)}function Jp(i,e){i.uniform3iv(this.addr,e)}function Qp(i,e){i.uniform4iv(this.addr,e)}function em(i,e){i.uniform1uiv(this.addr,e)}function tm(i,e){i.uniform2uiv(this.addr,e)}function nm(i,e){i.uniform3uiv(this.addr,e)}function im(i,e){i.uniform4uiv(this.addr,e)}function sm(i,e,t){const n=this.cache,s=e.length,r=fr(t,s);_t(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=Ha:a=vc;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function rm(i,e,t){const n=this.cache,s=e.length,r=fr(t,s);_t(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Sc,r[a])}function am(i,e,t){const n=this.cache,s=e.length,r=fr(t,s);_t(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||yc,r[a])}function om(i,e,t){const n=this.cache,s=e.length,r=fr(t,s);_t(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Mc,r[a])}function lm(i){switch(i){case 5126:return kp;case 35664:return Wp;case 35665:return Xp;case 35666:return Yp;case 35674:return qp;case 35675:return Kp;case 35676:return jp;case 5124:case 35670:return Zp;case 35667:case 35671:return $p;case 35668:case 35672:return Jp;case 35669:case 35673:return Qp;case 5125:return em;case 36294:return tm;case 36295:return nm;case 36296:return im;case 35678:case 36198:case 36298:case 36306:case 35682:return sm;case 35679:case 36299:case 36307:return rm;case 35680:case 36300:case 36308:case 36293:return am;case 36289:case 36303:case 36311:case 36292:return om}}class cm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Hp(t.type)}}class hm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=lm(t.type)}}class um{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const qr=/(\w+)(\])?(\[|\.)?/g;function ml(i,e){i.seq.push(e),i.map[e.id]=e}function dm(i,e,t){const n=i.name,s=n.length;for(qr.lastIndex=0;;){const r=qr.exec(n),a=qr.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){ml(t,c===void 0?new cm(o,i,e):new hm(o,i,e));break}else{let p=t.map[o];p===void 0&&(p=new um(o),ml(t,p)),t=p}}}class er{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);dm(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function _l(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const fm=37297;let pm=0;function mm(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const gl=new Le;function _m(i){ke._getMatrix(gl,ke.workingColorSpace,i);const e=`mat3( ${gl.elements.map(t=>t.toFixed(4))} )`;switch(ke.getTransfer(i)){case rr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function xl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+mm(i.getShaderSource(e),o)}else return r}function gm(i,e){const t=_m(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const xm={[Gl]:"Linear",[Hl]:"Reinhard",[kl]:"Cineon",[Wl]:"ACESFilmic",[Yl]:"AgX",[ql]:"Neutral",[Xl]:"Custom"};function vm(i,e){const t=xm[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ws=new U;function Mm(){ke.getLuminanceCoefficients(Ws);const i=Ws.x.toFixed(4),e=Ws.y.toFixed(4),t=Ws.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Cm={[Ks]:"SHADOWMAP_TYPE_PCF",[ns]:"SHADOWMAP_TYPE_VSM"};function Pm(i){return Cm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Dm={[ui]:"ENVMAP_TYPE_CUBE",[Vi]:"ENVMAP_TYPE_CUBE",[hr]:"ENVMAP_TYPE_CUBE_UV"};function Im(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Dm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Lm={[Vi]:"ENVMAP_MODE_REFRACTION"};function Um(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Lm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Nm={[Vl]:"ENVMAP_BLENDING_MULTIPLY",[Sh]:"ENVMAP_BLENDING_MIX",[yh]:"ENVMAP_BLENDING_ADD"};function Fm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Nm[i.combine]||"ENVMAP_BLENDING_NONE"}function Om(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Bm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Pm(t),c=Im(t),u=Um(t),p=Fm(t),h=Om(t),m=Sm(t),_=ym(r),x=s.createProgram();let f,d,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const T=S+f+a,E=S+d+o,R=_l(s,s.VERTEX_SHADER,T),A=_l(s,s.FRAGMENT_SHADER,E);s.attachShader(x,R),s.attachShader(x,A),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(w){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(x)||"",V=s.getShaderInfoLog(R)||"",k=s.getShaderInfoLog(A)||"",B=N.trim(),G=V.trim(),F=k.trim();let Q=!0,Z=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,R,A);else{const ce=xl(s,R,"vertex"),pe=xl(s,A,"fragment");Xe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`;class l_{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new pc(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new mn({vertexShader:a_,fragmentShader:o_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ft(new xs(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class c_ extends di{constructor(e,t){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,p=null,h=null,m=null,_=null;const x=typeof XRWebGLBinding<"u",f=new l_,d={},S=t.getContextAttributes();let T=null,E=null;const R=[],A=[],P=new Pe;let v=null;const y=new Vt;y.viewport=new ct;const X=new Vt;X.viewport=new ct;const w=[y,X],N=new vu;let V=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let ne=R[K];return ne===void 0&&(ne=new Tr,R[K]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function(K){let ne=R[K];return ne===void 0&&(ne=new Tr,R[K]=ne),ne.getGripSpace()},this.getHand=function(K){let ne=R[K];return ne===void 0&&(ne=new Tr,R[K]=ne),ne.getHandSpace()};function B(K){const ne=A.indexOf(K.inputSource);if(ne===-1)return;const re=R[ne];re!==void 0&&(re.update(K.inputSource,K.frame,c||a),re.dispatchEvent({type:K.type,data:K.inputSource}))}function G(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",F);for(let K=0;K<R.length;K++){const ne=A[K];ne!==null&&(A[K]=null,R[K].disconnect(ne))}V=null,k=null,f.reset();for(const K in d)delete d[K];e.setRenderTarget(T),m=null,h=null,p=null,s=null,E=null,rt.stop(),n.isPresenting=!1,e.setPixelRatio(v),e.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return p===null&&x&&(p=new XRWebGLBinding(s,t)),p},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(T=e.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",G),s.addEventListener("inputsourceschange",F),S.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(P),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let re=null,Ie=null,Te=null;S.depth&&(Te=S.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,re=S.stencil?si:Pn,Ie=S.stencil?us:fn);const we={colorFormat:t.RGBA8,depthFormat:Te,scaleFactor:r};p=this.getBinding(),h=p.createProjectionLayer(we),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),E=new dn(h.textureWidth,h.textureHeight,{format:Jt,type:Gt,depthTexture:new fs(h.textureWidth,h.textureHeight,Ie,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:S.stencil,colorSpace:e.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const re={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,t,re),s.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),E=new dn(m.framebufferWidth,m.framebufferHeight,{format:Jt,type:Gt,colorSpace:e.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),rt.setContext(s),rt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return f.getDepthTexture()};function F(K){for(let ne=0;ne<K.removed.length;ne++){const re=K.removed[ne],Ie=A.indexOf(re);Ie>=0&&(A[Ie]=null,R[Ie].disconnect(re))}for(let ne=0;ne<K.added.length;ne++){const re=K.added[ne];let Ie=A.indexOf(re);if(Ie===-1){for(let we=0;we<R.length;we++)if(we>=A.length){A.push(re),Ie=we;break}else if(A[we]===null){A[we]=re,Ie=we;break}if(Ie===-1)break}const Te=R[Ie];Te&&Te.connect(re)}}const Q=new U,Z=new U;function ce(K,ne,re){Q.setFromMatrixPosition(ne.matrixWorld),Z.setFromMatrixPosition(re.matrixWorld);const Ie=Q.distanceTo(Z),Te=ne.projectionMatrix.elements,we=re.projectionMatrix.elements,xt=Te[14]/(Te[10]-1),He=Te[14]/(Te[10]+1),Ke=(Te[9]+1)/Te[5],et=(Te[9]-1)/Te[5],Oe=(Te[8]-1)/Te[0],ht=(we[8]+1)/we[0],C=xt*Oe,dt=xt*ht,qe=Ie/(-Oe+ht),nt=qe*-Oe;if(ne.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(nt),K.translateZ(qe),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Te[10]===-1)K.projectionMatrix.copy(ne.projectionMatrix),K.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{const Me=xt+qe,b=He+qe,g=C-nt,I=dt+(Ie-nt),q=Ke*He/b*Me,j=et*He/b*Me;K.projectionMatrix.makePerspective(g,I,q,j,Me,b),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function pe(K,ne){ne===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(ne.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let ne=K.near,re=K.far;f.texture!==null&&(f.depthNear>0&&(ne=f.depthNear),f.depthFar>0&&(re=f.depthFar)),N.near=X.near=y.near=ne,N.far=X.far=y.far=re,(V!==N.near||k!==N.far)&&(s.updateRenderState({depthNear:N.near,depthFar:N.far}),V=N.near,k=N.far),N.layers.mask=K.layers.mask|6,y.layers.mask=N.layers.mask&-5,X.layers.mask=N.layers.mask&-3;const Ie=K.parent,Te=N.cameras;pe(N,Ie);for(let we=0;we<Te.length;we++)pe(Te[we],Ie);Te.length===2?ce(N,y,X):N.projectionMatrix.copy(y.projectionMatrix),ue(K,N,Ie)};function ue(K,ne,re){re===null?K.matrix.copy(ne.matrixWorld):(K.matrix.copy(re.matrixWorld),K.matrix.invert(),K.matrix.multiply(ne.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(ne.projectionMatrix),K.projectionMatrixInverse.copy(ne.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Va*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(K){l=K,h!==null&&(h.fixedFoveation=K),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=K)},this.hasDepthSensing=function(){return f.texture!==null},this.getDepthSensingMesh=function(){return f.getMesh(N)},this.getCameraTexture=function(K){return d[K]};let Ue=null;function at(K,ne){if(u=ne.getViewerPose(c||a),_=ne,u!==null){const re=u.views;m!==null&&(e.setRenderTargetFramebuffer(E,m.framebuffer),e.setRenderTarget(E));let Ie=!1;re.length!==N.cameras.length&&(N.cameras.length=0,Ie=!0);for(let He=0;He<re.length;He++){const Ke=re[He];let et=null;if(m!==null)et=m.getViewport(Ke);else{const ht=p.getViewSubImage(h,Ke);et=ht.viewport,He===0&&(e.setRenderTargetTextures(E,ht.colorTexture,ht.depthStencilTexture),e.setRenderTarget(E))}let Oe=w[He];Oe===void 0&&(Oe=new Vt,Oe.layers.enable(He),Oe.viewport=new ct,w[He]=Oe),Oe.matrix.fromArray(Ke.transform.matrix),Oe.matrix.decompose(Oe.position,Oe.quaternion,Oe.scale),Oe.projectionMatrix.fromArray(Ke.projectionMatrix),Oe.projectionMatrixInverse.copy(Oe.projectionMatrix).invert(),Oe.viewport.set(et.x,et.y,et.width,et.height),He===0&&(N.matrix.copy(Oe.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Ie===!0&&N.cameras.push(Oe)}const Te=s.enabledFeatures;if(Te&&Te.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){p=n.getBinding();const He=p.getDepthInformation(re[0]);He&&He.isValid&&He.texture&&f.init(He,s.renderState)}if(Te&&Te.includes("camera-access")&&x){e.state.unbindTexture(),p=n.getBinding();for(let He=0;He<re.length;He++){const Ke=re[He].camera;if(Ke){let et=d[Ke];et||(et=new pc,d[Ke]=et);const Oe=p.getCameraImage(Ke);et.sourceTexture=Oe}}}}for(let re=0;re<R.length;re++){const Ie=A[re],Te=R[re];Ie!==null&&Te!==void 0&&Te.update(Ie,ne,c||a)}Ue&&Ue(K,ne),ne.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ne}),_=null}const rt=new gc;rt.setAnimationLoop(at),this.setAnimationLoop=function(K){Ue=K},this.dispose=function(){}}}const Qn=new pn,h_=new Ye;function u_(i,e){function t(f,d){f.matrixAutoUpdate===!0&&f.updateMatrix(),d.value.copy(f.matrix)}function n(f,d){d.color.getRGB(f.fogColor.value,mc(i)),d.isFog?(f.fogNear.value=d.near,f.fogFar.value=d.far):d.isFogExp2&&(f.fogDensity.value=d.density)}function s(f,d,S,T,E){d.isMeshBasicMaterial?r(f,d):d.isMeshLambertMaterial?(r(f,d),d.envMap&&(f.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(r(f,d),p(f,d)):d.isMeshPhongMaterial?(r(f,d),u(f,d),d.envMap&&(f.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(r(f,d),h(f,d),d.isMeshPhysicalMaterial&&m(f,d,E)):d.isMeshMatcapMaterial?(r(f,d),_(f,d)):d.isMeshDepthMaterial?r(f,d):d.isMeshDistanceMaterial?(r(f,d),x(f,d)):d.isMeshNormalMaterial?r(f,d):d.isLineBasicMaterial?(a(f,d),d.isLineDashedMaterial&&o(f,d)):d.isPointsMaterial?l(f,d,S,T):d.isSpriteMaterial?c(f,d):d.isShadowMaterial?(f.color.value.copy(d.color),f.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(f,d){f.opacity.value=d.opacity,d.color&&f.diffuse.value.copy(d.color),d.emissive&&f.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(f.map.value=d.map,t(d.map,f.mapTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.bumpMap&&(f.bumpMap.value=d.bumpMap,t(d.bumpMap,f.bumpMapTransform),f.bumpScale.value=d.bumpScale,d.side===Nt&&(f.bumpScale.value*=-1)),d.normalMap&&(f.normalMap.value=d.normalMap,t(d.normalMap,f.normalMapTransform),f.normalScale.value.copy(d.normalScale),d.side===Nt&&f.normalScale.value.negate()),d.displacementMap&&(f.displacementMap.value=d.displacementMap,t(d.displacementMap,f.displacementMapTransform),f.displacementScale.value=d.displacementScale,f.displacementBias.value=d.displacementBias),d.emissiveMap&&(f.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,f.emissiveMapTransform)),d.specularMap&&(f.specularMap.value=d.specularMap,t(d.specularMap,f.specularMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest);const S=e.get(d),T=S.envMap,E=S.envMapRotation;T&&(f.envMap.value=T,Qn.copy(E),Qn.x*=-1,Qn.y*=-1,Qn.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(Qn.y*=-1,Qn.z*=-1),f.envMapRotation.value.setFromMatrix4(h_.makeRotationFromEuler(Qn)),f.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=d.reflectivity,f.ior.value=d.ior,f.refractionRatio.value=d.refractionRatio),d.lightMap&&(f.lightMap.value=d.lightMap,f.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,f.lightMapTransform)),d.aoMap&&(f.aoMap.value=d.aoMap,f.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,f.aoMapTransform))}function a(f,d){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,d.map&&(f.map.value=d.map,t(d.map,f.mapTransform))}function o(f,d){f.dashSize.value=d.dashSize,f.totalSize.value=d.dashSize+d.gapSize,f.scale.value=d.scale}function l(f,d,S,T){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,f.size.value=d.size*S,f.scale.value=T*.5,d.map&&(f.map.value=d.map,t(d.map,f.uvTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest)}function c(f,d){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,f.rotation.value=d.rotation,d.map&&(f.map.value=d.map,t(d.map,f.mapTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest)}function u(f,d){f.specular.value.copy(d.specular),f.shininess.value=Math.max(d.shininess,1e-4)}function p(f,d){d.gradientMap&&(f.gradientMap.value=d.gradientMap)}function h(f,d){f.metalness.value=d.metalness,d.metalnessMap&&(f.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,f.metalnessMapTransform)),f.roughness.value=d.roughness,d.roughnessMap&&(f.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,f.roughnessMapTransform)),d.envMap&&(f.envMapIntensity.value=d.envMapIntensity)}function m(f,d,S){f.ior.value=d.ior,d.sheen>0&&(f.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),f.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(f.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,f.sheenColorMapTransform)),d.sheenRoughnessMap&&(f.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,f.sheenRoughnessMapTransform))),d.clearcoat>0&&(f.clearcoat.value=d.clearcoat,f.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(f.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,f.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(f.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Nt&&f.clearcoatNormalScale.value.negate())),d.dispersion>0&&(f.dispersion.value=d.dispersion),d.iridescence>0&&(f.iridescence.value=d.iridescence,f.iridescenceIOR.value=d.iridescenceIOR,f.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(f.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,f.iridescenceMapTransform)),d.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),d.transmission>0&&(f.transmission.value=d.transmission,f.transmissionSamplerMap.value=S.texture,f.transmissionSamplerSize.value.set(S.width,S.height),d.transmissionMap&&(f.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,f.transmissionMapTransform)),f.thickness.value=d.thickness,d.thicknessMap&&(f.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=d.attenuationDistance,f.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(f.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(f.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=d.specularIntensity,f.specularColor.value.copy(d.specularColor),d.specularColorMap&&(f.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,f.specularColorMapTransform)),d.specularIntensityMap&&(f.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,f.specularIntensityMapTransform))}function _(f,d){d.matcap&&(f.matcap.value=d.matcap)}function x(f,d){const S=e.get(d).light;f.referencePosition.value.setFromMatrixPosition(S.matrixWorld),f.nearDistance.value=S.shadow.camera.near,f.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function d_(i,e,t,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,T){const E=T.program;n.uniformBlockBinding(S,E)}function c(S,T){let E=s[S.id];E===void 0&&(_(S),E=u(S),s[S.id]=E,S.addEventListener("dispose",f));const R=T.program;n.updateUBOMapping(S,R);const A=e.render.frame;r[S.id]!==A&&(h(S),r[S.id]=A)}function u(S){const T=p();S.__bindingPointIndex=T;const E=i.createBuffer(),R=S.__size,A=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,R,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function p(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Xe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){const T=s[S.id],E=S.uniforms,R=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let A=0,P=E.length;A<P;A++){const v=Array.isArray(E[A])?E[A]:[E[A]];for(let y=0,X=v.length;y<X;y++){const w=v[y];if(m(w,A,y,R)===!0){const N=w.__offset,V=Array.isArray(w.value)?w.value:[w.value];let k=0;for(let B=0;B<V.length;B++){const G=V[B],F=x(G);typeof G=="number"||typeof G=="boolean"?(w.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,N+k,w.__data)):G.isMatrix3?(w.__data[0]=G.elements[0],w.__data[1]=G.elements[1],w.__data[2]=G.elements[2],w.__data[3]=0,w.__data[4]=G.elements[3],w.__data[5]=G.elements[4],w.__data[6]=G.elements[5],w.__data[7]=0,w.__data[8]=G.elements[6],w.__data[9]=G.elements[7],w.__data[10]=G.elements[8],w.__data[11]=0):(G.toArray(w.__data,k),k+=F.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,N,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(S,T,E,R){const A=S.value,P=T+"_"+E;if(R[P]===void 0)return typeof A=="number"||typeof A=="boolean"?R[P]=A:R[P]=A.clone(),!0;{const v=R[P];if(typeof A=="number"||typeof A=="boolean"){if(v!==A)return R[P]=A,!0}else if(v.equals(A)===!1)return v.copy(A),!0}return!1}function _(S){const T=S.uniforms;let E=0;const R=16;for(let P=0,v=T.length;P<v;P++){const y=Array.isArray(T[P])?T[P]:[T[P]];for(let X=0,w=y.length;X<w;X++){const N=y[X],V=Array.isArray(N.value)?N.value:[N.value];for(let k=0,B=V.length;k<B;k++){const G=V[k],F=x(G),Q=E%R,Z=Q%F.boundary,ce=Q+Z;E+=Z,ce!==0&&R-ce<F.storage&&(E+=R-ce),N.__data=new Float32Array(F.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=E,E+=F.storage}}}const A=E%R;return A>0&&(E+=R-A),S.__size=E,S.__cache={},this}function x(S){const T={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(T.boundary=4,T.storage=4):S.isVector2?(T.boundary=8,T.storage=8):S.isVector3||S.isColor?(T.boundary=16,T.storage=12):S.isVector4?(T.boundary=16,T.storage=16):S.isMatrix3?(T.boundary=48,T.storage=48):S.isMatrix4?(T.boundary=64,T.storage=64):S.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Re("WebGLRenderer: Unsupported uniform value type.",S),T}function f(S){const T=S.target;T.removeEventListener("dispose",f);const E=a.indexOf(T.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function d(){for(const S in s)i.deleteBuffer(s[S]);a=[],s={},r={}}return{bind:l,update:c,dispose:d}}const f_=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let sn=null;function p_(){return sn===null&&(sn=new uc(f_,16,16,Gi,Cn),sn.name="DFG_LUT",sn.minFilter=Ct,sn.magFilter=Ct,sn.wrapS=bn,sn.wrapT=bn,sn.generateMipmaps=!1,sn.needsUpdate=!0),sn}class Ec{constructor(e={}){const{canvas:t=Lh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:m=Gt}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const x=m,f=new Set([so,io,no]),d=new Set([Gt,fn,hs,us,Qa,eo]),S=new Uint32Array(4),T=new Int32Array(4);let E=null,R=null;const A=[],P=[];let v=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=un,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let X=!1;this._outputColorSpace=kt;let w=0,N=0,V=null,k=-1,B=null;const G=new ct,F=new ct;let Q=null;const Z=new Ge(0);let ce=0,pe=t.width,ue=t.height,Ue=1,at=null,rt=null;const K=new ct(0,0,pe,ue),ne=new ct(0,0,pe,ue);let re=!1;const Ie=new lo;let Te=!1,we=!1;const xt=new Ye,He=new U,Ke=new ct,et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Oe=!1;function ht(){return V===null?Ue:1}let C=n;function dt(M,L){return t.getContext(M,L)}try{const M={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${$a}`),t.addEventListener("webglcontextlost",ge,!1),t.addEventListener("webglcontextrestored",Ce,!1),t.addEventListener("webglcontextcreationerror",it,!1),C===null){const L="webgl2";if(C=dt(L,M),C===null)throw dt(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Xe("WebGLRenderer: "+M.message),M}let qe,nt,Me,b,g,I,q,j,Y,me,ie,be,Ae,$,ee,_e,xe,he,Be,D,se,te,fe;function J(){qe=new mp(C),qe.init(),se=new r_(C,qe),nt=new op(C,qe,e,se),Me=new i_(C,qe),nt.reversedDepthBuffer&&h&&Me.buffers.depth.setReversed(!0),b=new xp(C),g=new km,I=new s_(C,qe,Me,g,nt,se,b),q=new pp(y),j=new yu(C),te=new rp(C,j),Y=new _p(C,j,b,te),me=new Mp(C,Y,j,te,b),he=new vp(C,nt,I),ee=new lp(g),ie=new Hm(y,q,qe,nt,te,ee),be=new u_(y,g),Ae=new Xm,$=new $m(qe),xe=new sp(y,q,Me,me,_,l),_e=new n_(y,me,nt),fe=new d_(C,b,nt,Me),Be=new ap(C,qe,b),D=new gp(C,qe,b),b.programs=ie.programs,y.capabilities=nt,y.extensions=qe,y.properties=g,y.renderLists=Ae,y.shadowMap=_e,y.state=Me,y.info=b}J(),x!==Gt&&(v=new yp(x,t.width,t.height,s,r));const W=new c_(y,C);this.xr=W,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const M=qe.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=qe.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Ue},this.setPixelRatio=function(M){M!==void 0&&(Ue=M,this.setSize(pe,ue,!1))},this.getSize=function(M){return M.set(pe,ue)},this.setSize=function(M,L,H=!0){if(W.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}pe=M,ue=L,t.width=Math.floor(M*Ue),t.height=Math.floor(L*Ue),H===!0&&(t.style.width=M+"px",t.style.height=L+"px"),v!==null&&v.setSize(t.width,t.height),this.setViewport(0,0,M,L)},this.getDrawingBufferSize=function(M){return M.set(pe*Ue,ue*Ue).floor()},this.setDrawingBufferSize=function(M,L,H){pe=M,ue=L,Ue=H,t.width=Math.floor(M*H),t.height=Math.floor(L*H),this.setViewport(0,0,M,L)},this.setEffects=function(M){if(x===Gt){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let L=0;L<M.length;L++)if(M[L].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}v.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(G)},this.getViewport=function(M){return M.copy(K)},this.setViewport=function(M,L,H,z){M.isVector4?K.set(M.x,M.y,M.z,M.w):K.set(M,L,H,z),Me.viewport(G.copy(K).multiplyScalar(Ue).round())},this.getScissor=function(M){return M.copy(ne)},this.setScissor=function(M,L,H,z){M.isVector4?ne.set(M.x,M.y,M.z,M.w):ne.set(M,L,H,z),Me.scissor(F.copy(ne).multiplyScalar(Ue).round())},this.getScissorTest=function(){return re},this.setScissorTest=function(M){Me.setScissorTest(re=M)},this.setOpaqueSort=function(M){at=M},this.setTransparentSort=function(M){rt=M},this.getClearColor=function(M){return M.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(M=!0,L=!0,H=!0){let z=0;if(M){let O=!1;if(V!==null){const oe=V.texture.format;O=f.has(oe)}if(O){const oe=V.texture.type,de=d.has(oe),le=xe.getClearColor(),ve=xe.getClearAlpha(),ye=le.r,De=le.g,ze=le.b;de?(S[0]=ye,S[1]=De,S[2]=ze,S[3]=ve,C.clearBufferuiv(C.COLOR,0,S)):(T[0]=ye,T[1]=De,T[2]=ze,T[3]=ve,C.clearBufferiv(C.COLOR,0,T))}else z|=C.COLOR_BUFFER_BIT}L&&(z|=C.DEPTH_BUFFER_BIT),H&&(z|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&C.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ge,!1),t.removeEventListener("webglcontextrestored",Ce,!1),t.removeEventListener("webglcontextcreationerror",it,!1),xe.dispose(),Ae.dispose(),$.dispose(),g.dispose(),q.dispose(),me.dispose(),te.dispose(),fe.dispose(),ie.dispose(),W.dispose(),W.removeEventListener("sessionstart",mo),W.removeEventListener("sessionend",_o),Yn.stop()};function ge(M){M.preventDefault(),Uo("WebGLRenderer: Context Lost."),X=!0}function Ce(){Uo("WebGLRenderer: Context Restored."),X=!1;const M=b.autoReset,L=_e.enabled,H=_e.autoUpdate,z=_e.needsUpdate,O=_e.type;J(),b.autoReset=M,_e.enabled=L,_e.autoUpdate=H,_e.needsUpdate=z,_e.type=O}function it(M){Xe("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function je(M){const L=M.target;L.removeEventListener("dispose",je),_n(L)}function _n(M){gn(M),g.remove(M)}function gn(M){const L=g.get(M).programs;L!==void 0&&(L.forEach(function(H){ie.releaseProgram(H)}),M.isShaderMaterial&&ie.releaseShaderCache(M))}this.renderBufferDirect=function(M,L,H,z,O,oe){L===null&&(L=et);const de=O.isMesh&&O.matrixWorld.determinant()<0,le=Vc(M,L,H,z,O);Me.setMaterial(z,de);let ve=H.index,ye=1;if(z.wireframe===!0){if(ve=Y.getWireframeAttribute(H),ve===void 0)return;ye=2}const De=H.drawRange,ze=H.attributes.position;let Ee=De.start*ye,$e=(De.start+De.count)*ye;oe!==null&&(Ee=Math.max(Ee,oe.start*ye),$e=Math.min($e,(oe.start+oe.count)*ye)),ve!==null?(Ee=Math.max(Ee,0),$e=Math.min($e,ve.count)):ze!=null&&(Ee=Math.max(Ee,0),$e=Math.min($e,ze.count));const ut=$e-Ee;if(ut<0||ut===1/0)return;te.setup(O,z,le,H,ve);let lt,Je=Be;if(ve!==null&&(lt=j.get(ve),Je=D,Je.setIndex(lt)),O.isMesh)z.wireframe===!0?(Me.setLineWidth(z.wireframeLinewidth*ht()),Je.setMode(C.LINES)):Je.setMode(C.TRIANGLES);else if(O.isLine){let At=z.linewidth;At===void 0&&(At=1),Me.setLineWidth(At*ht()),O.isLineSegments?Je.setMode(C.LINES):O.isLineLoop?Je.setMode(C.LINE_LOOP):Je.setMode(C.LINE_STRIP)}else O.isPoints?Je.setMode(C.POINTS):O.isSprite&&Je.setMode(C.TRIANGLES);if(O.isBatchedMesh)if(O._multiDrawInstances!==null)or("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Je.renderMultiDrawInstances(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount,O._multiDrawInstances);else if(qe.get("WEBGL_multi_draw"))Je.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{const At=O._multiDrawStarts,Se=O._multiDrawCounts,Ot=O._multiDrawCount,We=ve?j.get(ve).bytesPerElement:1,Wt=g.get(z).currentProgram.getUniforms();for(let tn=0;tn<Ot;tn++)Wt.setValue(C,"_gl_DrawID",tn),Je.render(At[tn]/We,Se[tn])}else if(O.isInstancedMesh)Je.renderInstances(Ee,ut,O.count);else if(H.isInstancedBufferGeometry){const At=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Se=Math.min(H.instanceCount,At);Je.renderInstances(Ee,ut,Se)}else Je.render(Ee,ut)};function po(M,L,H){M.transparent===!0&&M.side===En&&M.forceSinglePass===!1?(M.side=Nt,M.needsUpdate=!0,Ms(M,L,H),M.side=Wn,M.needsUpdate=!0,Ms(M,L,H),M.side=En):Ms(M,L,H)}this.compile=function(M,L,H=null){H===null&&(H=M),R=$.get(H),R.init(L),P.push(R),H.traverseVisible(function(O){O.isLight&&O.layers.test(L.layers)&&(R.pushLight(O),O.castShadow&&R.pushShadow(O))}),M!==H&&M.traverseVisible(function(O){O.isLight&&O.layers.test(L.layers)&&(R.pushLight(O),O.castShadow&&R.pushShadow(O))}),R.setupLights();const z=new Set;return M.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;const oe=O.material;if(oe)if(Array.isArray(oe))for(let de=0;de<oe.length;de++){const le=oe[de];po(le,H,O),z.add(le)}else po(oe,H,O),z.add(oe)}),R=P.pop(),z},this.compileAsync=function(M,L,H=null){const z=this.compile(M,L,H);return new Promise(O=>{function oe(){if(z.forEach(function(de){g.get(de).currentProgram.isReady()&&z.delete(de)}),z.size===0){O(M);return}setTimeout(oe,10)}qe.get("KHR_parallel_shader_compile")!==null?oe():setTimeout(oe,10)})};let pr=null;function zc(M){pr&&pr(M)}function mo(){Yn.stop()}function _o(){Yn.start()}const Yn=new gc;Yn.setAnimationLoop(zc),typeof self<"u"&&Yn.setContext(self),this.setAnimationLoop=function(M){pr=M,W.setAnimationLoop(M),M===null?Yn.stop():Yn.start()},W.addEventListener("sessionstart",mo),W.addEventListener("sessionend",_o),this.render=function(M,L){if(L!==void 0&&L.isCamera!==!0){Xe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(X===!0)return;const H=W.enabled===!0&&W.isPresenting===!0,z=v!==null&&(V===null||H)&&v.begin(y,V);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(v===null||v.isCompositing()===!1)&&(W.cameraAutoUpdate===!0&&W.updateCamera(L),L=W.getCamera()),M.isScene===!0&&M.onBeforeRender(y,M,L,V),R=$.get(M,P.length),R.init(L),P.push(R),xt.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Ie.setFromProjectionMatrix(xt,ln,L.reversedDepth),we=this.localClippingEnabled,Te=ee.init(this.clippingPlanes,we),E=Ae.get(M,A.length),E.init(),A.push(E),W.enabled===!0&&W.isPresenting===!0){const de=y.xr.getDepthSensingMesh();de!==null&&mr(de,L,-1/0,y.sortObjects)}mr(M,L,0,y.sortObjects),E.finish(),y.sortObjects===!0&&E.sort(at,rt),Oe=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Oe&&xe.addToRenderList(E,M),this.info.render.frame++,Te===!0&&ee.beginShadows();const O=R.state.shadowsArray;if(_e.render(O,M,L),Te===!0&&ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),(z&&v.hasRenderPass())===!1){const de=E.opaque,le=E.transmissive;if(R.setupLights(),L.isArrayCamera){const ve=L.cameras;if(le.length>0)for(let ye=0,De=ve.length;ye<De;ye++){const ze=ve[ye];xo(de,le,M,ze)}Oe&&xe.render(M);for(let ye=0,De=ve.length;ye<De;ye++){const ze=ve[ye];go(E,M,ze,ze.viewport)}}else le.length>0&&xo(de,le,M,L),Oe&&xe.render(M),go(E,M,L)}V!==null&&N===0&&(I.updateMultisampleRenderTarget(V),I.updateRenderTargetMipmap(V)),z&&v.end(y),M.isScene===!0&&M.onAfterRender(y,M,L),te.resetDefaultState(),k=-1,B=null,P.pop(),P.length>0?(R=P[P.length-1],Te===!0&&ee.setGlobalState(y.clippingPlanes,R.state.camera)):R=null,A.pop(),A.length>0?E=A[A.length-1]:E=null};function mr(M,L,H,z){if(M.visible===!1)return;if(M.layers.test(L.layers)){if(M.isGroup)H=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(L);else if(M.isLight)R.pushLight(M),M.castShadow&&R.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Ie.intersectsSprite(M)){z&&Ke.setFromMatrixPosition(M.matrixWorld).applyMatrix4(xt);const de=me.update(M),le=M.material;le.visible&&E.push(M,de,le,H,Ke.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Ie.intersectsObject(M))){const de=me.update(M),le=M.material;if(z&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Ke.copy(M.boundingSphere.center)):(de.boundingSphere===null&&de.computeBoundingSphere(),Ke.copy(de.boundingSphere.center)),Ke.applyMatrix4(M.matrixWorld).applyMatrix4(xt)),Array.isArray(le)){const ve=de.groups;for(let ye=0,De=ve.length;ye<De;ye++){const ze=ve[ye],Ee=le[ze.materialIndex];Ee&&Ee.visible&&E.push(M,de,Ee,H,Ke.z,ze)}}else le.visible&&E.push(M,de,le,H,Ke.z,null)}}const oe=M.children;for(let de=0,le=oe.length;de<le;de++)mr(oe[de],L,H,z)}function go(M,L,H,z){const{opaque:O,transmissive:oe,transparent:de}=M;R.setupLightsView(H),Te===!0&&ee.setGlobalState(y.clippingPlanes,H),z&&Me.viewport(G.copy(z)),O.length>0&&vs(O,L,H),oe.length>0&&vs(oe,L,H),de.length>0&&vs(de,L,H),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function xo(M,L,H,z){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(R.state.transmissionRenderTarget[z.id]===void 0){const Ee=qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float");R.state.transmissionRenderTarget[z.id]=new dn(1,1,{generateMipmaps:!0,type:Ee?Cn:Gt,minFilter:ii,samples:Math.max(4,nt.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ke.workingColorSpace})}const oe=R.state.transmissionRenderTarget[z.id],de=z.viewport||G;oe.setSize(de.z*y.transmissionResolutionScale,de.w*y.transmissionResolutionScale);const le=y.getRenderTarget(),ve=y.getActiveCubeFace(),ye=y.getActiveMipmapLevel();y.setRenderTarget(oe),y.getClearColor(Z),ce=y.getClearAlpha(),ce<1&&y.setClearColor(16777215,.5),y.clear(),Oe&&xe.render(H);const De=y.toneMapping;y.toneMapping=un;const ze=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),R.setupLightsView(z),Te===!0&&ee.setGlobalState(y.clippingPlanes,z),vs(M,H,z),I.updateMultisampleRenderTarget(oe),I.updateRenderTargetMipmap(oe),qe.has("WEBGL_multisampled_render_to_texture")===!1){let Ee=!1;for(let $e=0,ut=L.length;$e<ut;$e++){const lt=L[$e],{object:Je,geometry:At,material:Se,group:Ot}=lt;if(Se.side===En&&Je.layers.test(z.layers)){const We=Se.side;Se.side=Nt,Se.needsUpdate=!0,vo(Je,H,z,At,Se,Ot),Se.side=We,Se.needsUpdate=!0,Ee=!0}}Ee===!0&&(I.updateMultisampleRenderTarget(oe),I.updateRenderTargetMipmap(oe))}y.setRenderTarget(le,ve,ye),y.setClearColor(Z,ce),ze!==void 0&&(z.viewport=ze),y.toneMapping=De}function vs(M,L,H){const z=L.isScene===!0?L.overrideMaterial:null;for(let O=0,oe=M.length;O<oe;O++){const de=M[O],{object:le,geometry:ve,group:ye}=de;let De=de.material;De.allowOverride===!0&&z!==null&&(De=z),le.layers.test(H.layers)&&vo(le,L,H,ve,De,ye)}}function vo(M,L,H,z,O,oe){M.onBeforeRender(y,L,H,z,O,oe),M.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),O.onBeforeRender(y,L,H,z,M,oe),O.transparent===!0&&O.side===En&&O.forceSinglePass===!1?(O.side=Nt,O.needsUpdate=!0,y.renderBufferDirect(H,L,z,O,M,oe),O.side=Wn,O.needsUpdate=!0,y.renderBufferDirect(H,L,z,O,M,oe),O.side=En):y.renderBufferDirect(H,L,z,O,M,oe),M.onAfterRender(y,L,H,z,O,oe)}function Ms(M,L,H){L.isScene!==!0&&(L=et);const z=g.get(M),O=R.state.lights,oe=R.state.shadowsArray,de=O.state.version,le=ie.getParameters(M,O.state,oe,L,H),ve=ie.getProgramCacheKey(le);let ye=z.programs;z.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?L.environment:null,z.fog=L.fog;const De=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;z.envMap=q.get(M.envMap||z.environment,De),z.envMapRotation=z.environment!==null&&M.envMap===null?L.environmentRotation:M.envMapRotation,ye===void 0&&(M.addEventListener("dispose",je),ye=new Map,z.programs=ye);let ze=ye.get(ve);if(ze!==void 0){if(z.currentProgram===ze&&z.lightsStateVersion===de)return So(M,le),ze}else le.uniforms=ie.getUniforms(M),M.onBeforeCompile(le,y),ze=ie.acquireProgram(le,ve),ye.set(ve,ze),z.uniforms=le.uniforms;const Ee=z.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ee.clippingPlanes=ee.uniform),So(M,le),z.needsLights=Hc(M),z.lightsStateVersion=de,z.needsLights&&(Ee.ambientLightColor.value=O.state.ambient,Ee.lightProbe.value=O.state.probe,Ee.directionalLights.value=O.state.directional,Ee.directionalLightShadows.value=O.state.directionalShadow,Ee.spotLights.value=O.state.spot,Ee.spotLightShadows.value=O.state.spotShadow,Ee.rectAreaLights.value=O.state.rectArea,Ee.ltc_1.value=O.state.rectAreaLTC1,Ee.ltc_2.value=O.state.rectAreaLTC2,Ee.pointLights.value=O.state.point,Ee.pointLightShadows.value=O.state.pointShadow,Ee.hemisphereLights.value=O.state.hemi,Ee.directionalShadowMatrix.value=O.state.directionalShadowMatrix,Ee.spotLightMatrix.value=O.state.spotLightMatrix,Ee.spotLightMap.value=O.state.spotLightMap,Ee.pointShadowMatrix.value=O.state.pointShadowMatrix),z.currentProgram=ze,z.uniformsList=null,ze}function Mo(M){if(M.uniformsList===null){const L=M.currentProgram.getUniforms();M.uniformsList=er.seqWithValue(L.seq,M.uniforms)}return M.uniformsList}function So(M,L){const H=g.get(M);H.outputColorSpace=L.outputColorSpace,H.batching=L.batching,H.batchingColor=L.batchingColor,H.instancing=L.instancing,H.instancingColor=L.instancingColor,H.instancingMorph=L.instancingMorph,H.skinning=L.skinning,H.morphTargets=L.morphTargets,H.morphNormals=L.morphNormals,H.morphColors=L.morphColors,H.morphTargetsCount=L.morphTargetsCount,H.numClippingPlanes=L.numClippingPlanes,H.numIntersection=L.numClipIntersection,H.vertexAlphas=L.vertexAlphas,H.vertexTangents=L.vertexTangents,H.toneMapping=L.toneMapping}function Vc(M,L,H,z,O){L.isScene!==!0&&(L=et),I.resetTextureUnits();const oe=L.fog,de=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?L.environment:null,le=V===null?y.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:Hi,ve=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,ye=q.get(z.envMap||de,ve),De=z.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,ze=!!H.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Ee=!!H.morphAttributes.position,$e=!!H.morphAttributes.normal,ut=!!H.morphAttributes.color;let lt=un;z.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(lt=y.toneMapping);const Je=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,At=Je!==void 0?Je.length:0,Se=g.get(z),Ot=R.state.lights;if(Te===!0&&(we===!0||M!==B)){const vt=M===B&&z.id===k;ee.setState(z,M,vt)}let We=!1;z.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==Ot.state.version||Se.outputColorSpace!==le||O.isBatchedMesh&&Se.batching===!1||!O.isBatchedMesh&&Se.batching===!0||O.isBatchedMesh&&Se.batchingColor===!0&&O.colorTexture===null||O.isBatchedMesh&&Se.batchingColor===!1&&O.colorTexture!==null||O.isInstancedMesh&&Se.instancing===!1||!O.isInstancedMesh&&Se.instancing===!0||O.isSkinnedMesh&&Se.skinning===!1||!O.isSkinnedMesh&&Se.skinning===!0||O.isInstancedMesh&&Se.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&Se.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&Se.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&Se.instancingMorph===!1&&O.morphTexture!==null||Se.envMap!==ye||z.fog===!0&&Se.fog!==oe||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==ee.numPlanes||Se.numIntersection!==ee.numIntersection)||Se.vertexAlphas!==De||Se.vertexTangents!==ze||Se.morphTargets!==Ee||Se.morphNormals!==$e||Se.morphColors!==ut||Se.toneMapping!==lt||Se.morphTargetsCount!==At)&&(We=!0):(We=!0,Se.__version=z.version);let Wt=Se.currentProgram;We===!0&&(Wt=Ms(z,L,O));let tn=!1,qn=!1,pi=!1;const tt=Wt.getUniforms(),St=Se.uniforms;if(Me.useProgram(Wt.program)&&(tn=!0,qn=!0,pi=!0),z.id!==k&&(k=z.id,qn=!0),tn||B!==M){Me.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),tt.setValue(C,"projectionMatrix",M.projectionMatrix),tt.setValue(C,"viewMatrix",M.matrixWorldInverse);const In=tt.map.cameraPosition;In!==void 0&&In.setValue(C,He.setFromMatrixPosition(M.matrixWorld)),nt.logarithmicDepthBuffer&&tt.setValue(C,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&tt.setValue(C,"isOrthographic",M.isOrthographicCamera===!0),B!==M&&(B=M,qn=!0,pi=!0)}if(Se.needsLights&&(Ot.state.directionalShadowMap.length>0&&tt.setValue(C,"directionalShadowMap",Ot.state.directionalShadowMap,I),Ot.state.spotShadowMap.length>0&&tt.setValue(C,"spotShadowMap",Ot.state.spotShadowMap,I),Ot.state.pointShadowMap.length>0&&tt.setValue(C,"pointShadowMap",Ot.state.pointShadowMap,I)),O.isSkinnedMesh){tt.setOptional(C,O,"bindMatrix"),tt.setOptional(C,O,"bindMatrixInverse");const vt=O.skeleton;vt&&(vt.boneTexture===null&&vt.computeBoneTexture(),tt.setValue(C,"boneTexture",vt.boneTexture,I))}O.isBatchedMesh&&(tt.setOptional(C,O,"batchingTexture"),tt.setValue(C,"batchingTexture",O._matricesTexture,I),tt.setOptional(C,O,"batchingIdTexture"),tt.setValue(C,"batchingIdTexture",O._indirectTexture,I),tt.setOptional(C,O,"batchingColorTexture"),O._colorsTexture!==null&&tt.setValue(C,"batchingColorTexture",O._colorsTexture,I));const Dn=H.morphAttributes;if((Dn.position!==void 0||Dn.normal!==void 0||Dn.color!==void 0)&&he.update(O,H,Wt),(qn||Se.receiveShadow!==O.receiveShadow)&&(Se.receiveShadow=O.receiveShadow,tt.setValue(C,"receiveShadow",O.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&L.environment!==null&&(St.envMapIntensity.value=L.environmentIntensity),St.dfgLUT!==void 0&&(St.dfgLUT.value=p_()),qn&&(tt.setValue(C,"toneMappingExposure",y.toneMappingExposure),Se.needsLights&&Gc(St,pi),oe&&z.fog===!0&&be.refreshFogUniforms(St,oe),be.refreshMaterialUniforms(St,z,Ue,ue,R.state.transmissionRenderTarget[M.id]),er.upload(C,Mo(Se),St,I)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(er.upload(C,Mo(Se),St,I),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&tt.setValue(C,"center",O.center),tt.setValue(C,"modelViewMatrix",O.modelViewMatrix),tt.setValue(C,"normalMatrix",O.normalMatrix),tt.setValue(C,"modelMatrix",O.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const vt=z.uniformsGroups;for(let In=0,mi=vt.length;In<mi;In++){const yo=vt[In];fe.update(yo,Wt),fe.bind(yo,Wt)}}return Wt}function Gc(M,L){M.ambientLightColor.needsUpdate=L,M.lightProbe.needsUpdate=L,M.directionalLights.needsUpdate=L,M.directionalLightShadows.needsUpdate=L,M.pointLights.needsUpdate=L,M.pointLightShadows.needsUpdate=L,M.spotLights.needsUpdate=L,M.spotLightShadows.needsUpdate=L,M.rectAreaLights.needsUpdate=L,M.hemisphereLights.needsUpdate=L}function Hc(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return N},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(M,L,H){const z=g.get(M);z.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),g.get(M.texture).__webglTexture=L,g.get(M.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:H,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,L){const H=g.get(M);H.__webglFramebuffer=L,H.__useDefaultFramebuffer=L===void 0};const kc=C.createFramebuffer();this.setRenderTarget=function(M,L=0,H=0){V=M,w=L,N=H;let z=null,O=!1,oe=!1;if(M){const le=g.get(M);if(le.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(C.FRAMEBUFFER,le.__webglFramebuffer),G.copy(M.viewport),F.copy(M.scissor),Q=M.scissorTest,Me.viewport(G),Me.scissor(F),Me.setScissorTest(Q),k=-1;return}else if(le.__webglFramebuffer===void 0)I.setupRenderTarget(M);else if(le.__hasExternalTextures)I.rebindTextures(M,g.get(M.texture).__webglTexture,g.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const De=M.depthTexture;if(le.__boundDepthTexture!==De){if(De!==null&&g.has(De)&&(M.width!==De.image.width||M.height!==De.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");I.setupDepthRenderbuffer(M)}}const ve=M.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(oe=!0);const ye=g.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(ye[L])?z=ye[L][H]:z=ye[L],O=!0):M.samples>0&&I.useMultisampledRTT(M)===!1?z=g.get(M).__webglMultisampledFramebuffer:Array.isArray(ye)?z=ye[H]:z=ye,G.copy(M.viewport),F.copy(M.scissor),Q=M.scissorTest}else G.copy(K).multiplyScalar(Ue).floor(),F.copy(ne).multiplyScalar(Ue).floor(),Q=re;if(H!==0&&(z=kc),Me.bindFramebuffer(C.FRAMEBUFFER,z)&&Me.drawBuffers(M,z),Me.viewport(G),Me.scissor(F),Me.setScissorTest(Q),O){const le=g.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+L,le.__webglTexture,H)}else if(oe){const le=L;for(let ve=0;ve<M.textures.length;ve++){const ye=g.get(M.textures[ve]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+ve,ye.__webglTexture,H,le)}}else if(M!==null&&H!==0){const le=g.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,le.__webglTexture,H)}k=-1},this.readRenderTargetPixels=function(M,L,H,z,O,oe,de,le=0){if(!(M&&M.isWebGLRenderTarget)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=g.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&de!==void 0&&(ve=ve[de]),ve){Me.bindFramebuffer(C.FRAMEBUFFER,ve);try{const ye=M.textures[le],De=ye.format,ze=ye.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+le),!nt.textureFormatReadable(De)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(ze)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=M.width-z&&H>=0&&H<=M.height-O&&C.readPixels(L,H,z,O,se.convert(De),se.convert(ze),oe)}finally{const ye=V!==null?g.get(V).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,ye)}}},this.readRenderTargetPixelsAsync=async function(M,L,H,z,O,oe,de,le=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=g.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&de!==void 0&&(ve=ve[de]),ve)if(L>=0&&L<=M.width-z&&H>=0&&H<=M.height-O){Me.bindFramebuffer(C.FRAMEBUFFER,ve);const ye=M.textures[le],De=ye.format,ze=ye.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+le),!nt.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ee=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Ee),C.bufferData(C.PIXEL_PACK_BUFFER,oe.byteLength,C.STREAM_READ),C.readPixels(L,H,z,O,se.convert(De),se.convert(ze),0);const $e=V!==null?g.get(V).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,$e);const ut=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Uh(C,ut,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Ee),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,oe),C.deleteBuffer(Ee),C.deleteSync(ut),oe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,L=null,H=0){const z=Math.pow(2,-H),O=Math.floor(M.image.width*z),oe=Math.floor(M.image.height*z),de=L!==null?L.x:0,le=L!==null?L.y:0;I.setTexture2D(M,0),C.copyTexSubImage2D(C.TEXTURE_2D,H,0,0,de,le,O,oe),Me.unbindTexture()};const Wc=C.createFramebuffer(),Xc=C.createFramebuffer();this.copyTextureToTexture=function(M,L,H=null,z=null,O=0,oe=0){let de,le,ve,ye,De,ze,Ee,$e,ut;const lt=M.isCompressedTexture?M.mipmaps[oe]:M.image;if(H!==null)de=H.max.x-H.min.x,le=H.max.y-H.min.y,ve=H.isBox3?H.max.z-H.min.z:1,ye=H.min.x,De=H.min.y,ze=H.isBox3?H.min.z:0;else{const St=Math.pow(2,-O);de=Math.floor(lt.width*St),le=Math.floor(lt.height*St),M.isDataArrayTexture?ve=lt.depth:M.isData3DTexture?ve=Math.floor(lt.depth*St):ve=1,ye=0,De=0,ze=0}z!==null?(Ee=z.x,$e=z.y,ut=z.z):(Ee=0,$e=0,ut=0);const Je=se.convert(L.format),At=se.convert(L.type);let Se;L.isData3DTexture?(I.setTexture3D(L,0),Se=C.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(I.setTexture2DArray(L,0),Se=C.TEXTURE_2D_ARRAY):(I.setTexture2D(L,0),Se=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,L.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,L.unpackAlignment);const Ot=C.getParameter(C.UNPACK_ROW_LENGTH),We=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Wt=C.getParameter(C.UNPACK_SKIP_PIXELS),tn=C.getParameter(C.UNPACK_SKIP_ROWS),qn=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,lt.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,lt.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,ye),C.pixelStorei(C.UNPACK_SKIP_ROWS,De),C.pixelStorei(C.UNPACK_SKIP_IMAGES,ze);const pi=M.isDataArrayTexture||M.isData3DTexture,tt=L.isDataArrayTexture||L.isData3DTexture;if(M.isDepthTexture){const St=g.get(M),Dn=g.get(L),vt=g.get(St.__renderTarget),In=g.get(Dn.__renderTarget);Me.bindFramebuffer(C.READ_FRAMEBUFFER,vt.__webglFramebuffer),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,In.__webglFramebuffer);for(let mi=0;mi<ve;mi++)pi&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(M).__webglTexture,O,ze+mi),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(L).__webglTexture,oe,ut+mi)),C.blitFramebuffer(ye,De,de,le,Ee,$e,de,le,C.DEPTH_BUFFER_BIT,C.NEAREST);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(O!==0||M.isRenderTargetTexture||g.has(M)){const St=g.get(M),Dn=g.get(L);Me.bindFramebuffer(C.READ_FRAMEBUFFER,Wc),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,Xc);for(let vt=0;vt<ve;vt++)pi?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,St.__webglTexture,O,ze+vt):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,St.__webglTexture,O),tt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Dn.__webglTexture,oe,ut+vt):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Dn.__webglTexture,oe),O!==0?C.blitFramebuffer(ye,De,de,le,Ee,$e,de,le,C.COLOR_BUFFER_BIT,C.NEAREST):tt?C.copyTexSubImage3D(Se,oe,Ee,$e,ut+vt,ye,De,de,le):C.copyTexSubImage2D(Se,oe,Ee,$e,ye,De,de,le);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else tt?M.isDataTexture||M.isData3DTexture?C.texSubImage3D(Se,oe,Ee,$e,ut,de,le,ve,Je,At,lt.data):L.isCompressedArrayTexture?C.compressedTexSubImage3D(Se,oe,Ee,$e,ut,de,le,ve,Je,lt.data):C.texSubImage3D(Se,oe,Ee,$e,ut,de,le,ve,Je,At,lt):M.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,oe,Ee,$e,de,le,Je,At,lt.data):M.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,oe,Ee,$e,lt.width,lt.height,Je,lt.data):C.texSubImage2D(C.TEXTURE_2D,oe,Ee,$e,de,le,Je,At,lt);C.pixelStorei(C.UNPACK_ROW_LENGTH,Ot),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,We),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Wt),C.pixelStorei(C.UNPACK_SKIP_ROWS,tn),C.pixelStorei(C.UNPACK_SKIP_IMAGES,qn),oe===0&&L.generateMipmaps&&C.generateMipmap(Se),Me.unbindTexture()},this.initRenderTarget=function(M){g.get(M).__webglFramebuffer===void 0&&I.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?I.setTextureCube(M,0):M.isData3DTexture?I.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?I.setTexture2DArray(M,0):I.setTexture2D(M,0),Me.unbindTexture()},this.resetState=function(){w=0,N=0,V=null,Me.reset(),te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}const wl={type:"change"},fo={type:"start"},bc={type:"end"},Xs=new cc,Rl=new Vn,m_=Math.cos(70*Oh.DEG2RAD),mt=new U,Ut=2*Math.PI,Qe={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},jr=1e-6;class Tc extends Mu{constructor(e,t=null){super(e,t),this.state=Qe.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Li.ROTATE,MIDDLE:Li.DOLLY,RIGHT:Li.PAN},this.touches={ONE:Ii.ROTATE,TWO:Ii.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new Xn,this._lastTargetPosition=new U,this._quat=new Xn().setFromUnitVectors(e.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new nl,this._sphericalDelta=new nl,this._scale=1,this._panOffset=new U,this._rotateStart=new Pe,this._rotateEnd=new Pe,this._rotateDelta=new Pe,this._panStart=new Pe,this._panEnd=new Pe,this._panDelta=new Pe,this._dollyStart=new Pe,this._dollyEnd=new Pe,this._dollyDelta=new Pe,this._dollyDirection=new U,this._mouse=new Pe,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=g_.bind(this),this._onPointerDown=__.bind(this),this._onPointerUp=x_.bind(this),this._onContextMenu=T_.bind(this),this._onMouseWheel=S_.bind(this),this._onKeyDown=y_.bind(this),this._onTouchStart=E_.bind(this),this._onTouchMove=b_.bind(this),this._onMouseDown=v_.bind(this),this._onMouseMove=M_.bind(this),this._interceptControlDown=A_.bind(this),this._interceptControlUp=w_.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(wl),this.update(),this.state=Qe.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){const t=this.object.position;mt.copy(t).sub(this.target),mt.applyQuaternion(this._quat),this._spherical.setFromVector3(mt),this.autoRotate&&this.state===Qe.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=Ut:n>Math.PI&&(n-=Ut),s<-Math.PI?s+=Ut:s>Math.PI&&(s-=Ut),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(mt.setFromSpherical(this._spherical),mt.applyQuaternion(this._quatInverse),t.copy(this.target).add(mt),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=mt.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const o=new U(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new U(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=mt.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Xs.origin.copy(this.object.position),Xs.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Xs.direction))<m_?this.object.lookAt(this.target):(Rl.setFromNormalAndCoplanarPoint(this.object.up,this.target),Xs.intersectPlane(Rl,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>jr||8*(1-this._lastQuaternion.dot(this.object.quaternion))>jr||this._lastTargetPosition.distanceToSquared(this.target)>jr?(this.dispatchEvent(wl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Ut/60*this.autoRotateSpeed*e:Ut/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){mt.setFromMatrixColumn(t,0),mt.multiplyScalar(-e),this._panOffset.add(mt)}_panUp(e,t){this.screenSpacePanning===!0?mt.setFromMatrixColumn(t,1):(mt.setFromMatrixColumn(t,0),mt.crossVectors(this.object.up,mt)),mt.multiplyScalar(e),this._panOffset.add(mt)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;mt.copy(s).sub(this.target);let r=mt.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*r/n.clientHeight,this.object.matrix),this._panUp(2*t*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),s=e-n.left,r=t-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Ut*this._rotateDelta.x/t.clientHeight),this._rotateUp(Ut*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Ut*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Ut*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Ut*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Ut*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panStart.set(n,s)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),s=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Ut*this._rotateDelta.x/t.clientHeight),this._rotateUp(Ut*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Pe,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function __(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function g_(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function x_(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(bc),this.state=Qe.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function v_(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Li.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=Qe.DOLLY;break;case Li.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qe.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qe.ROTATE}break;case Li.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Qe.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Qe.PAN}break;default:this.state=Qe.NONE}this.state!==Qe.NONE&&this.dispatchEvent(fo)}function M_(i){switch(this.state){case Qe.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case Qe.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case Qe.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function S_(i){this.enabled===!1||this.enableZoom===!1||this.state!==Qe.NONE||(i.preventDefault(),this.dispatchEvent(fo),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(bc))}function y_(i){this.enabled!==!1&&this._handleKeyDown(i)}function E_(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Ii.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=Qe.TOUCH_ROTATE;break;case Ii.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=Qe.TOUCH_PAN;break;default:this.state=Qe.NONE}break;case 2:switch(this.touches.TWO){case Ii.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=Qe.TOUCH_DOLLY_PAN;break;case Ii.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=Qe.TOUCH_DOLLY_ROTATE;break;default:this.state=Qe.NONE}break;default:this.state=Qe.NONE}this.state!==Qe.NONE&&this.dispatchEvent(fo)}function b_(i){switch(this._trackPointer(i),this.state){case Qe.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case Qe.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case Qe.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case Qe.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=Qe.NONE}}function T_(i){this.enabled!==!1&&i.preventDefault()}function A_(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function w_(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const st={background:1710618,sphere:3815994,inMaze:7829367,frontier:9489145,open:10473317,closed:6663631,path:13190983,start:8508666,end:16747109,dim:1973790},Cl={[st.path]:6,[st.start]:5,[st.end]:5,[st.closed]:4,[st.open]:3,[st.frontier]:2,[st.inMaze]:1,[st.sphere]:0,[st.dim]:-1},R_=.1,Pl=.065,C_=new Ye().makeRotationX(Math.PI/2),P_=new Ye().makeRotationZ(-Math.PI/2),rn=new Ye,zn=new Ge,Di=new Ye().makeScale(0,0,0);class D_{constructor(e){Ne(this,"scene",new ac);Ne(this,"camera");Ne(this,"glRenderer");Ne(this,"controls");Ne(this,"rafId",0);Ne(this,"sphereIM");Ne(this,"nsTubeIM");Ne(this,"ewTubeIM");Ne(this,"udTubeIM");Ne(this,"lastKey","");Ne(this,"loop",()=>{this.rafId=requestAnimationFrame(this.loop),this.controls.update(),this.glRenderer.render(this.scene,this.camera)});this.canvas=e,this.scene.background=new Ge(st.background),this.camera=new Vt(50,e.width/e.height,.1,500),this.glRenderer=new Ec({canvas:e,antialias:!0}),this.glRenderer.setSize(e.width,e.height,!1),this.glRenderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.controls=new Tc(this.camera,e),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.maxPolarAngle=Math.PI,this.scene.add(new gu(16777215,.9));const t=new Ga(16777215,.5);t.position.set(10,20,15),this.scene.add(t),this.rafId=requestAnimationFrame(this.loop)}resize(){this.camera.aspect=this.canvas.width/this.canvas.height,this.camera.updateProjectionMatrix(),this.glRenderer.setSize(this.canvas.width,this.canvas.height,!1)}dispose(){cancelAnimationFrame(this.rafId),this.controls.dispose(),this.glRenderer.dispose()}drawMaze(e,t={}){const n=`${e.rows}x${e.cols}x${e.layers}`;n!==this.lastKey&&(this.buildGeometry(e),this.lastKey=n),this.updateSpheres(e,t),this.updateTubes(e,t)}buildGeometry(e){const{rows:t,cols:n,layers:s}=e;if(this.lastKey){this.scene.remove(this.sphereIM,this.nsTubeIM,this.ewTubeIM,this.udTubeIM);for(const x of[this.sphereIM,this.nsTubeIM,this.ewTubeIM,this.udTubeIM])x.geometry.dispose(),x.material.dispose()}const r=t*n*s,a=(t-1)*n*s,o=t*(n-1)*s,l=t*n*(s-1);this.sphereIM=new ri(new co(R_,8,6),new ti({color:16777215,roughness:.6,metalness:.1}),r);for(let x=0;x<s;x++)for(let f=0;f<t;f++)for(let d=0;d<n;d++){const S=e.cellKey({row:f,col:d,layer:x});rn.makeTranslation(d,x,f),this.sphereIM.setMatrixAt(S,rn),this.sphereIM.setColorAt(S,zn.set(st.sphere))}this.sphereIM.instanceMatrix.needsUpdate=!0,this.sphereIM.instanceColor.needsUpdate=!0,this.scene.add(this.sphereIM);const c=new ti({color:16777215,roughness:.5,metalness:.15}),u=new ur(Pl,Pl,1,8);this.nsTubeIM=new ri(u,c,a);for(let x=0;x<a;x++)this.nsTubeIM.setMatrixAt(x,Di),this.nsTubeIM.setColorAt(x,zn.set(st.inMaze));this.nsTubeIM.instanceMatrix.needsUpdate=!0,this.nsTubeIM.instanceColor.needsUpdate=!0,this.scene.add(this.nsTubeIM),this.ewTubeIM=new ri(u,c,o);for(let x=0;x<o;x++)this.ewTubeIM.setMatrixAt(x,Di),this.ewTubeIM.setColorAt(x,zn.set(st.inMaze));this.ewTubeIM.instanceMatrix.needsUpdate=!0,this.ewTubeIM.instanceColor.needsUpdate=!0,this.scene.add(this.ewTubeIM),this.udTubeIM=new ri(u,c,l);for(let x=0;x<l;x++)this.udTubeIM.setMatrixAt(x,Di),this.udTubeIM.setColorAt(x,zn.set(st.inMaze));this.udTubeIM.instanceMatrix.needsUpdate=!0,this.udTubeIM.instanceColor.needsUpdate=!0,this.scene.add(this.udTubeIM);const p=(n-1)/2,h=(s-1)/2,m=(t-1)/2,_=Math.max(t,n,s)*1.4;this.controls.target.set(p,h,m),this.camera.position.set(p+_,h+_,m+_*1.1),this.camera.lookAt(p,h,m),this.controls.update()}nodeColor(e,t,n,s,r,a){var o,l,c,u;return e===s?st.start:e===r?st.end:a?n.has(e)?st.path:st.dim:n.has(e)?st.path:(o=t.closed)!=null&&o.has(e)?st.closed:(l=t.open)!=null&&l.has(e)?st.open:(c=t.frontier)!=null&&c.has(e)?st.frontier:(u=t.inMaze)!=null&&u.has(e)?st.inMaze:st.sphere}updateSpheres(e,t){var u;const{rows:n,cols:s,layers:r}=e,a=new Set(((u=t.path)==null?void 0:u.map(p=>e.cellKey(p)))??[]),o=t.start?e.cellKey(t.start):-1,l=t.end?e.cellKey(t.end):-1,c=a.size>0;for(let p=0;p<r;p++)for(let h=0;h<n;h++)for(let m=0;m<s;m++){const _=e.cellKey({row:h,col:m,layer:p});this.sphereIM.setColorAt(_,zn.set(this.nodeColor(_,t,a,o,l,c)))}this.sphereIM.instanceColor.needsUpdate=!0}updateTubes(e,t){var m;const{rows:n,cols:s,layers:r}=e,a=new Set(((m=t.path)==null?void 0:m.map(_=>e.cellKey(_)))??[]),o=t.start?e.cellKey(t.start):-1,l=t.end?e.cellKey(t.end):-1,c=a.size>0,u=new Set,p=t.path??[];for(let _=0;_<p.length-1;_++){const x=e.cellKey(p[_]),f=e.cellKey(p[_+1]);u.add(x*n*s*r+f),u.add(f*n*s*r+x)}const h=(_,x)=>{if(u.has(_*n*s*r+x))return st.path;if(c)return st.dim;const f=this.nodeColor(_,t,a,o,l,!1),d=this.nodeColor(x,t,a,o,l,!1);return(Cl[f]??0)>=(Cl[d]??0)?f:d};for(let _=0;_<n-1;_++)for(let x=0;x<s;x++)for(let f=0;f<r;f++){const d=_*s*r+x*r+f;if(!e.hasWall({row:_,col:x,layer:f},li)){rn.copy(C_),rn.setPosition(x,f,_+.5);const T=e.cellKey({row:_,col:x,layer:f}),E=e.cellKey({row:_+1,col:x,layer:f});this.nsTubeIM.setMatrixAt(d,rn),this.nsTubeIM.setColorAt(d,zn.set(h(T,E)))}else this.nsTubeIM.setMatrixAt(d,Di)}this.nsTubeIM.instanceMatrix.needsUpdate=!0,this.nsTubeIM.instanceColor.needsUpdate=!0;for(let _=0;_<n;_++)for(let x=0;x<s-1;x++)for(let f=0;f<r;f++){const d=_*(s-1)*r+x*r+f;if(!e.hasWall({row:_,col:x,layer:f},ci)){rn.copy(P_),rn.setPosition(x+.5,f,_);const T=e.cellKey({row:_,col:x,layer:f}),E=e.cellKey({row:_,col:x+1,layer:f});this.ewTubeIM.setMatrixAt(d,rn),this.ewTubeIM.setColorAt(d,zn.set(h(T,E)))}else this.ewTubeIM.setMatrixAt(d,Di)}this.ewTubeIM.instanceMatrix.needsUpdate=!0,this.ewTubeIM.instanceColor.needsUpdate=!0;for(let _=0;_<n;_++)for(let x=0;x<s;x++)for(let f=0;f<r-1;f++){const d=_*s*(r-1)+x*(r-1)+f;if(!e.hasWall({row:_,col:x,layer:f},hi)){rn.makeTranslation(x,f+.5,_);const T=e.cellKey({row:_,col:x,layer:f}),E=e.cellKey({row:_,col:x,layer:f+1});this.udTubeIM.setMatrixAt(d,rn),this.udTubeIM.setColorAt(d,zn.set(h(T,E)))}else this.udTubeIM.setMatrixAt(d,Di)}this.udTubeIM.instanceMatrix.needsUpdate=!0,this.udTubeIM.instanceColor.needsUpdate=!0}}const Wa=document.getElementById("canvas-cube"),Ac=document.getElementById("btn-cube-gen"),wc=document.getElementById("btn-cube-solve"),Xa=document.getElementById("cube-speed"),I_=document.getElementById("cube-speed-label"),Ya=document.getElementById("cube-size"),L_=document.getElementById("cube-size-label"),qa=document.getElementById("cube-openings"),U_=document.getElementById("cube-openings-label"),N_=document.getElementById("cube-title");let Wi=null,Fi=null,Oi=!1;function F_(){return Number(Ya.value)}const Et={inMaze:new Set,open:new Set,closed:new Set,path:[],start:{row:0,col:0,layer:0},end:{row:0,col:0,layer:0}};function Rc(i){return new Promise(e=>setTimeout(e,i))}function Cc(){return Number(Xa.value)}function lr(i){Ac.disabled=i,wc.disabled=i}function rs(){!Wi||!Fi||Fi.drawMaze(Wi,Et)}async function Dl(){if(Oi)return;Oi=!0,lr(!0);const i=F_();Et.start={row:0,col:0,layer:0},Et.end={row:i-1,col:i-1,layer:i-1},Wi=new Jc(i,i,i),Et.inMaze.clear(),Et.open.clear(),Et.closed.clear(),Et.path=[];const e=Wi;for await(const n of Qc(e)){if(n.type==="visit"&&(Et.inMaze.add(e.cellKey(n.cell)),rs()),n.type==="done")break;await Rc(Cc())}const t=Number(qa.value);if(t>0){const n=[];for(let r=0;r<i;r++)for(let a=0;a<i;a++)for(let o=0;o<i;o++){const l={row:a,col:o,layer:r};o+1<i&&e.hasWall(l,ci)&&n.push([l,{row:a,col:o+1,layer:r}]),a+1<i&&e.hasWall(l,li)&&n.push([l,{row:a+1,col:o,layer:r}]),r+1<i&&e.hasWall(l,hi)&&n.push([l,{row:a,col:o,layer:r+1}])}for(let r=n.length-1;r>0;r--){const a=Math.floor(Math.random()*(r+1));[n[r],n[a]]=[n[a],n[r]]}const s=Math.min(t,n.length);for(let r=0;r<s;r++)e.removeWall(n[r][0],n[r][1])}rs(),Oi=!1,lr(!1)}async function O_(){if(!Wi||Oi)return;Oi=!0,lr(!0),Et.open.clear(),Et.closed.clear(),Et.path=[];const i=Wi;for await(const e of eh(i,Et.start,Et.end)){if(e.type==="open")Et.open.add(i.cellKey(e.cell)),rs();else if(e.type==="close")Et.closed.add(i.cellKey(e.cell)),Et.open.delete(i.cellKey(e.cell)),rs();else if(e.type==="done"){Et.path=e.path,rs();break}await Rc(Cc())}Oi=!1,lr(!1)}function B_(){Fi=new D_(Wa),Ac.addEventListener("click",Dl),wc.addEventListener("click",O_),Xa.addEventListener("input",()=>{I_.textContent=`${Xa.value} ms`}),Ya.addEventListener("input",()=>{const i=Ya.value;L_.textContent=`${i}×${i}×${i}`,N_.textContent=`Cube 3D — ${i}×${i}×${i}`}),qa.addEventListener("input",()=>{U_.textContent=qa.value}),Dl()}function Pc(){const i=document.getElementById("cube-controls"),t=document.getElementById("cube-title").offsetHeight+i.offsetHeight+100,n=Math.min(window.innerWidth-40,window.innerHeight-t);Wa.width=Math.max(300,n),Wa.height=Math.max(300,n),Fi==null||Fi.resize()}class z_{async*generate(e){const t=new Set,n=[],s=c=>{const u=e.cellKey(c);!t.has(u)&&!n.some(p=>e.cellKey(p)===u)&&n.push(c)},r=c=>{t.add(e.cellKey(c));for(const u of e.neighbors(c))s(u)},a=Math.floor(Math.random()*e.rows),o=Math.floor(Math.random()*e.cols),l={row:a,col:o};for(r(l),yield{type:"visit",cell:l,frontier:[...n]};n.length>0;){const c=Math.floor(Math.random()*n.length),u=n.splice(c,1)[0],p=e.neighbors(u).filter(m=>t.has(e.cellKey(m)));if(p.length===0)continue;const h=p[Math.floor(Math.random()*p.length)];e.removeWall(u,h),r(u),yield{type:"visit",cell:u,frontier:[...n]}}yield{type:"done",cell:l}}}class V_{async*generate(e){const t=new Set,n=[],s=Math.floor(Math.random()*e.rows),r=Math.floor(Math.random()*e.cols),a={row:s,col:r};for(t.add(e.cellKey(a)),n.push(a),yield{type:"visit",cell:a};n.length>0;){const o=n[n.length-1],l=e.neighbors(o).filter(u=>!t.has(e.cellKey(u)));if(l.length===0){n.pop();continue}const c=l[Math.floor(Math.random()*l.length)];e.removeWall(o,c),t.add(e.cellKey(c)),n.push(c),yield{type:"visit",cell:c,frontier:[...n]}}yield{type:"done",cell:a}}}class G_{async*generate(e){const t=[],n=[],s=(a,o)=>{const l=n.findIndex(u=>u.some(p=>p.row===a.row&&p.col===a.col));return l===-1?!1:n[l].some(u=>u.row===o.row&&u.col===o.col)};for(let a=0;a<e.rows;a++)for(let o=0;o<e.cols;o++)a<e.rows-1&&t.push({a:{row:a,col:o},b:{row:a+1,col:o}}),o<e.cols-1&&t.push({a:{row:a,col:o},b:{row:a,col:o+1}});function r(a){for(let o=a.length-1;o>0;o--){const l=Math.floor(Math.random()*(o+1));[a[o],a[l]]=[a[l],a[o]]}}r(t);for(let a=0;a<e.rows;a++)for(let o=0;o<e.cols;o++)n.push([{row:a,col:o}]);for(;n.length>1&&t.length>0;){const a=t.pop(),o=a.a,l=a.b;if(!s(o,l)){e.removeWall(o,l);const c=n.findIndex(p=>p.some(h=>h.row===o.row&&h.col===o.col)),u=n.findIndex(p=>p.some(h=>h.row===l.row&&h.col===l.col));n[c].push(...n[u]),n.splice(u,1),yield{type:"visit",cell:o}}}yield{type:"done",cell:{row:0,col:0}}}}class H_{async*generate(e){for(let t=0;t<e.rows;t++)for(let n=0;n<e.cols;n++){const s={row:t,col:n},r=[];if(t>0&&r.push({row:t-1,col:n}),n<e.cols-1&&r.push({row:t,col:n+1}),r.length>0){const a=r[Math.floor(Math.random()*r.length)];e.removeWall(s,a)}yield{type:"visit",cell:s}}yield{type:"done",cell:{row:0,col:0}}}}class k_{async*generate(e){const t=new Set,n=Math.floor(Math.random()*e.rows),s=Math.floor(Math.random()*e.cols);let r={row:n,col:s};for(t.add(e.cellKey(r)),yield{type:"visit",cell:r};;){const a=e.neighbors(r).filter(o=>!t.has(e.cellKey(o)));if(a.length>0){const o=a[Math.floor(Math.random()*a.length)];e.removeWall(r,o),t.add(e.cellKey(o)),r=o,yield{type:"visit",cell:r}}else{let o=!1;e:for(let l=0;l<e.rows;l++)for(let c=0;c<e.cols;c++){const u={row:l,col:c};if(t.has(e.cellKey(u)))continue;const p=e.neighbors(u).filter(h=>t.has(e.cellKey(h)));if(p.length>0){const h=p[Math.floor(Math.random()*p.length)];e.removeWall(u,h),t.add(e.cellKey(u)),r=u,yield{type:"visit",cell:r},o=!0;break e}}if(!o)break}}yield{type:"done",cell:r}}}class W_{async*generate(e){for(let t=0;t<e.rows;t++)for(let n=0;n<e.cols;n++)t>0&&e.removeWall({row:t,col:n},{row:t-1,col:n}),n<e.cols-1&&e.removeWall({row:t,col:n},{row:t,col:n+1});yield{type:"visit",cell:{row:0,col:0}},yield*ss(e,0,0,e.rows,e.cols),yield{type:"done",cell:{row:0,col:0}}}}async function*ss(i,e,t,n,s){if(n<2||s<2)return;if(n>s?!0:s>n?!1:Math.random()<.5){const a=e+1+Math.floor(Math.random()*(n-1)),o=t+Math.floor(Math.random()*s);for(let l=t;l<t+s;l++)l!==o&&(i.addWall({row:a-1,col:l},cn),yield{type:"visit",cell:{row:a-1,col:l}});yield*ss(i,e,t,a-e,s),yield*ss(i,a,t,e+n-a,s)}else{const a=t+1+Math.floor(Math.random()*(s-1)),o=e+Math.floor(Math.random()*n);for(let l=e;l<e+n;l++)l!==o&&(i.addWall({row:l,col:a-1},hn),yield{type:"visit",cell:{row:l,col:a-1}});yield*ss(i,e,t,n,a-t),yield*ss(i,e,a,n,t+s-a)}}function Il(i,e){return Math.abs(i.row-e.row)+Math.abs(i.col-e.col)}class X_{async*solve(e,t,n){const s=e.cellKey(t),r=e.cellKey(n),a=new Map([[s,0]]),o=new Map([[s,Il(t,n)]]),l=new Map,c=new Set,u=new Set([s]),p=()=>{let h=-1,m=1/0;for(const _ of u){const x=o.get(_)??1/0;x<m&&(m=x,h=_)}return u.delete(h),h};for(;u.size>0;){const h=p(),m=e.fromKey(h);if(h===r){const _=[];let x=r;for(;x!==void 0;)_.unshift(e.fromKey(x)),x=l.get(x);yield{type:"path",cell:m,path:_},yield{type:"done",cell:m};return}c.add(h),yield{type:"close",cell:m};for(const _ of e.passableNeighbors(m)){const x=e.cellKey(_);if(c.has(x))continue;const f=(a.get(h)??1/0)+1;f<(a.get(x)??1/0)&&(l.set(x,h),a.set(x,f),o.set(x,f+Il(_,n)),u.has(x)||(u.add(x),yield{type:"open",cell:_}))}}yield{type:"done",cell:t}}}class Y_{async*solve(e,t,n){const s=e.cellKey(t),r=e.cellKey(n),a=new Map,o=new Set([s]),l=new Set,c=[s];for(;c.length>0;){const u=c.shift(),p=e.fromKey(u);if(u===r){const h=[];let m=r;for(;m!==void 0;)h.unshift(e.fromKey(m)),m=a.get(m);yield{type:"path",cell:p,path:h},yield{type:"done",cell:p};return}l.add(u),o.delete(u),yield{type:"close",cell:p};for(const h of e.passableNeighbors(p)){const m=e.cellKey(h);l.has(m)||o.has(m)||(a.set(m,u),o.add(m),c.push(m),yield{type:"open",cell:h})}}yield{type:"done",cell:t}}}class q_{async*solve(e,t,n){const s=e.cellKey(t),r=e.cellKey(n),a=new Map,o=new Set([s]),l=new Set,c=[s];for(;c.length>0;){const u=c.pop(),p=e.fromKey(u);if(!l.has(u)){if(u===r){const h=[];let m=r;for(;m!==void 0;)h.unshift(e.fromKey(m)),m=a.get(m);yield{type:"path",cell:p,path:h},yield{type:"done",cell:p};return}l.add(u),o.delete(u),yield{type:"close",cell:p};for(const h of e.passableNeighbors(p)){const m=e.cellKey(h);l.has(m)||(a.set(m,u),o.add(m),c.push(m),yield{type:"open",cell:h})}}}yield{type:"done",cell:t}}}const Kt={background:"#C7C7C7",wall:"#1a1a1a",unvisited:"#7D7D7D",inMaze:"#B8B8B8",frontier:"#90caf9",open:"#9FCF65",closed:"#65ADCF",path:"#C94747",start:"#81d4fa",end:"#9E3C3C"};class K_{constructor(e){Ne(this,"ctx");Ne(this,"cellSize",0);this.canvas=e;const t=e.getContext("2d");if(!t)throw new Error("Could not get 2D canvas context");this.ctx=t}computeCellSize(e){return Math.floor(Math.min(this.canvas.width/e.cols,this.canvas.height/e.rows))}drawMaze(e,t={}){var o,l,c,u,p,h;const{ctx:n}=this;this.cellSize=this.computeCellSize(e);const s=this.cellSize,r=Math.floor((this.canvas.width-e.cols*s)/2),a=Math.floor((this.canvas.height-e.rows*s)/2);n.fillStyle=Kt.background,n.fillRect(0,0,this.canvas.width,this.canvas.height);for(let m=0;m<e.rows;m++)for(let _=0;_<e.cols;_++){const x=r+_*s,f=a+m*s,d=e.cellKey({row:m,col:_}),S=(((o=t.path)==null?void 0:o.length)??0)>0;let T=Kt.unvisited;(l=t.path)!=null&&l.some(E=>E.row===m&&E.col===_)?T=Kt.path:(c=t.closed)!=null&&c.has(d)?T=S?"rgba(101,173,207,0.3)":Kt.closed:(u=t.open)!=null&&u.has(d)?T=S?"rgba(159,207,101,0.3)":Kt.open:(p=t.frontier)!=null&&p.has(d)?T=Kt.frontier:(h=t.inMaze)!=null&&h.has(d)&&(T=Kt.inMaze),n.fillStyle=T,n.fillRect(x+1,f+1,s-1,s-1),n.strokeStyle=Kt.wall,n.lineWidth=1.5,e.hasWall({row:m,col:_},Tn)&&(n.beginPath(),n.moveTo(x,f),n.lineTo(x+s,f),n.stroke()),e.hasWall({row:m,col:_},cn)&&(n.beginPath(),n.moveTo(x,f+s),n.lineTo(x+s,f+s),n.stroke()),e.hasWall({row:m,col:_},An)&&(n.beginPath(),n.moveTo(x,f),n.lineTo(x,f+s),n.stroke()),e.hasWall({row:m,col:_},hn)&&(n.beginPath(),n.moveTo(x+s,f),n.lineTo(x+s,f+s),n.stroke())}n.strokeStyle=Kt.wall,n.lineWidth=1.5,n.strokeRect(r,a,e.cols*s,e.rows*s),t.start&&this.drawMarker(t.start,Kt.start,r,a),t.end&&this.drawMarker(t.end,Kt.end,r,a)}drawMarker(e,t,n,s){const r=this.cellSize,a=n+e.col*r+r/2,o=s+e.row*r+r/2,l=r*.3;this.ctx.beginPath(),this.ctx.arc(a,o,l,0,Math.PI*2),this.ctx.fillStyle=t,this.ctx.fill()}}const yt={background:13092807,wall:7564910,ground:8224125,unvisited:8224125,inMaze:12105912,frontier:9489145,open:10473317,closed:6663631,openFaded:11452822,closedFaded:9876417,path:13190983,start:8508666,end:10370108},jt={unvisited:.01,inMaze:.07,frontier:.12,open:.2,closed:.32,path:.54,marker:.4},Ll=.7,Ys=.35,qs=.2,pt=new Ye,an=new Ge,Ul=new Ye().makeScale(0,0,0);function j_(){const e=document.createElement("canvas");e.width=e.height=256;const t=e.getContext("2d");t.fillStyle="#888888",t.fillRect(0,0,256,256);for(let s=0;s<120;s++){const r=Math.random()*256,a=Math.random()*256,o=4+Math.random()*10,l=2+Math.random()*6,c=45+Math.random()*30;t.beginPath(),t.ellipse(r,a,o,l,Math.random()*Math.PI,0,Math.PI*2),t.fillStyle=`hsl(0,0%,${c}%)`,t.fill()}const n=new fc(e);return n.wrapS=n.wrapT=sr,n.repeat.set(2,2),n}function Z_(){const e=document.createElement("canvas");e.width=e.height=128;const t=e.getContext("2d");for(let n=0;n<128;n+=2)for(let s=0;s<128;s+=2){const r=200+Math.floor(Math.random()*55);t.fillStyle=`rgb(${r},${r},${r})`,t.fillRect(n,s,2,2)}return new fc(e)}class $_{constructor(e){Ne(this,"scene",new ac);Ne(this,"camera");Ne(this,"glRenderer");Ne(this,"controls");Ne(this,"rafId",0);Ne(this,"floorIM");Ne(this,"hWallIM");Ne(this,"vWallIM");Ne(this,"hWallH");Ne(this,"vWallH");Ne(this,"startMesh",null);Ne(this,"endMesh",null);Ne(this,"groundMesh",null);Ne(this,"lastRows",-1);Ne(this,"lastCols",-1);Ne(this,"sun");Ne(this,"hedgeTex",j_());Ne(this,"noiseTex",Z_());Ne(this,"loop",()=>{this.rafId=requestAnimationFrame(this.loop),this.controls.update(),this.glRenderer.render(this.scene,this.camera)});this.canvas=e,this.scene.background=new Ge(yt.background),this.camera=new Vt(50,e.width/e.height,.1,500),this.glRenderer=new Ec({canvas:e,antialias:!0}),this.glRenderer.setSize(e.width,e.height,!1),this.glRenderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.glRenderer.shadowMap.enabled=!0,this.glRenderer.shadowMap.type=zl,this.controls=new Tc(this.camera,e),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.minDistance=2,this.controls.maxPolarAngle=Math.PI/2.05,this.scene.add(new pu(8900331,4878384,.75)),this.sun=new Ga(16776166,1),this.sun.castShadow=!0,this.sun.shadow.mapSize.width=2048,this.sun.shadow.mapSize.height=2048,this.sun.shadow.bias=-8e-4,this.scene.add(this.sun),this.scene.add(this.sun.target);const t=new Ga(13164799,.3);t.position.set(-5,8,-5),this.scene.add(t),this.rafId=requestAnimationFrame(this.loop)}resize(){this.camera.aspect=this.canvas.width/this.canvas.height,this.camera.updateProjectionMatrix(),this.glRenderer.setSize(this.canvas.width,this.canvas.height,!1)}dispose(){cancelAnimationFrame(this.rafId),this.controls.dispose(),this.glRenderer.dispose()}drawMaze(e,t={}){(e.rows!==this.lastRows||e.cols!==this.lastCols)&&this.buildGeometry(e),this.updateFloorTiles(e,t),this.updateWallVisibility(e),this.updateMarkers(t)}buildGeometry(e){const{rows:t,cols:n}=e;this.lastRows!==-1&&(this.scene.remove(this.floorIM,this.hWallIM,this.vWallIM),this.floorIM.geometry.dispose(),this.floorIM.material.dispose(),this.hWallIM.geometry.dispose(),this.hWallIM.material.dispose(),this.vWallIM.geometry.dispose(),this.vWallIM.material.dispose()),this.groundMesh&&(this.scene.remove(this.groundMesh),this.groundMesh.geometry.dispose(),this.groundMesh.material.dispose()),this.groundMesh=new Ft(new xs(n+2,t+2),new ti({color:yt.ground,roughness:1,metalness:0})),this.groundMesh.rotation.x=-Math.PI/2,this.groundMesh.position.set((n-1)/2,-.005,(t-1)/2),this.groundMesh.receiveShadow=!0,this.scene.add(this.groundMesh);const s=t*n;this.floorIM=new ri(new kn(.96,1,.96),new ti({map:this.noiseTex,roughness:.85,metalness:0}),s),this.floorIM.castShadow=!0,this.floorIM.receiveShadow=!0;for(let m=0;m<s;m++){const _=jt.unvisited;pt.makeScale(1,_,1),pt.setPosition(m%n,_/2,Math.floor(m/n)),this.floorIM.setMatrixAt(m,pt),this.floorIM.setColorAt(m,an.set(yt.unvisited))}this.floorIM.instanceMatrix.needsUpdate=!0,this.floorIM.instanceColor.needsUpdate=!0,this.scene.add(this.floorIM);const r=new ti({map:this.hedgeTex,roughness:.95,metalness:0}),a=(t+1)*n;this.hWallH=new Float32Array(a),this.hWallIM=new ri(new kn(1+Ys,1,Ys),r,a),this.hWallIM.castShadow=!0,this.hWallIM.receiveShadow=!0;for(let m=0;m<=t;m++)for(let _=0;_<n;_++){const x=m*n+_,f=Ll*(1-qs/2+Math.random()*qs);this.hWallH[x]=f,pt.makeScale(1,f,1),pt.setPosition(_,f/2,m-.5),this.hWallIM.setMatrixAt(x,pt),an.set(yt.wall);const d={h:0,s:0,l:0};an.getHSL(d),an.setHSL(d.h,d.s,d.l+(Math.random()-.5)*.08),this.hWallIM.setColorAt(x,an)}this.hWallIM.instanceMatrix.needsUpdate=!0,this.hWallIM.instanceColor.needsUpdate=!0,this.scene.add(this.hWallIM);const o=t*(n+1);this.vWallH=new Float32Array(o),this.vWallIM=new ri(new kn(Ys,1,1+Ys),r,o),this.vWallIM.castShadow=!0,this.vWallIM.receiveShadow=!0;for(let m=0;m<t;m++)for(let _=0;_<=n;_++){const x=m*(n+1)+_,f=Ll*(1-qs/2+Math.random()*qs);this.vWallH[x]=f,pt.makeScale(1,f,1),pt.setPosition(_-.5,f/2,m),this.vWallIM.setMatrixAt(x,pt),an.set(yt.wall);const d={h:0,s:0,l:0};an.getHSL(d),an.setHSL(d.h,d.s,d.l+(Math.random()-.5)*.08),this.vWallIM.setColorAt(x,an)}this.vWallIM.instanceMatrix.needsUpdate=!0,this.vWallIM.instanceColor.needsUpdate=!0,this.scene.add(this.vWallIM);const l=(n-1)/2,c=(t-1)/2,u=Math.max(t,n)*.9;this.controls.target.set(l,0,c),this.camera.position.set(l,u,c+u),this.camera.lookAt(l,0,c),this.controls.update();const p=Math.max(t,n)*.65+3;this.sun.position.set(l+p*.6,p*1.8,c+p*.8),this.sun.target.position.set(l,0,c),this.sun.target.updateMatrixWorld();const h=this.sun.shadow.camera;h.left=-p,h.right=p,h.top=p,h.bottom=-p,h.near=.5,h.far=p*5,h.updateProjectionMatrix(),this.lastRows=t,this.lastCols=n}updateFloorTiles(e,t){var r,a,o,l,c,u,p,h,m,_;const{rows:n,cols:s}=e;for(let x=0;x<n;x++)for(let f=0;f<s;f++){const d=e.cellKey({row:x,col:f});let S=yt.unvisited,T=jt.unvisited;const E=(((r=t.path)==null?void 0:r.length)??0)>0;(a=t.path)!=null&&a.some(R=>R.row===x&&R.col===f)?(S=yt.path,T=jt.path):(o=t.closed)!=null&&o.has(d)?(S=E?yt.closedFaded:yt.closed,T=jt.closed):(l=t.open)!=null&&l.has(d)?(S=E?yt.openFaded:yt.open,T=jt.open):(c=t.frontier)!=null&&c.has(d)?(S=yt.frontier,T=jt.frontier):(u=t.inMaze)!=null&&u.has(d)&&(S=yt.inMaze,T=jt.inMaze),((p=t.start)==null?void 0:p.row)===x&&((h=t.start)==null?void 0:h.col)===f&&(S=yt.start,T=jt.marker),((m=t.end)==null?void 0:m.row)===x&&((_=t.end)==null?void 0:_.col)===f&&(S=yt.end,T=jt.marker),pt.makeScale(1,T,1),pt.setPosition(f,T/2,x),this.floorIM.setMatrixAt(x*s+f,pt),this.floorIM.setColorAt(x*s+f,an.set(S))}this.floorIM.instanceMatrix.needsUpdate=!0,this.floorIM.instanceColor.needsUpdate=!0}updateWallVisibility(e){const{rows:t,cols:n}=e;for(let s=0;s<=t;s++)for(let r=0;r<n;r++){let a;s===0?a=e.hasWall({row:0,col:r},Tn):s===t?a=e.hasWall({row:t-1,col:r},cn):a=e.hasWall({row:s,col:r},Tn);const o=s*n+r;if(a){const l=this.hWallH[o];pt.makeScale(1,l,1),pt.setPosition(r,l/2,s-.5)}else pt.copy(Ul);this.hWallIM.setMatrixAt(o,pt)}this.hWallIM.instanceMatrix.needsUpdate=!0;for(let s=0;s<t;s++)for(let r=0;r<=n;r++){let a;r===0?a=e.hasWall({row:s,col:0},An):r===n?a=e.hasWall({row:s,col:n-1},hn):a=e.hasWall({row:s,col:r},An);const o=s*(n+1)+r;if(a){const l=this.vWallH[o];pt.makeScale(1,l,1),pt.setPosition(r-.5,l/2,s)}else pt.copy(Ul);this.vWallIM.setMatrixAt(o,pt)}this.vWallIM.instanceMatrix.needsUpdate=!0}updateMarkers(e){this.startMesh&&this.scene.remove(this.startMesh),this.endMesh&&this.scene.remove(this.endMesh),this.startMesh=null,this.endMesh=null;const t=new ur(.15,.18,.35,16);e.start&&(this.startMesh=new Ft(t,new ti({color:yt.start,roughness:.4,metalness:.2})),this.startMesh.position.set(e.start.col,jt.marker+.18,e.start.row),this.startMesh.castShadow=!0,this.scene.add(this.startMesh)),e.end&&(this.endMesh=new Ft(t,new ti({color:yt.end,roughness:.4,metalness:.2})),this.endMesh.position.set(e.end.col,jt.marker+.18,e.end.row),this.endMesh.castShadow=!0,this.scene.add(this.endMesh))}}const ps=document.getElementById("maze-canvas"),as=document.getElementById("maze-canvas-3d"),Dc=document.getElementById("btn-generate"),Ic=document.getElementById("btn-solve"),tr=document.getElementById("btn-toggle-view"),nr=document.getElementById("size-slider"),J_=document.getElementById("size-label"),Ka=document.getElementById("speed-slider"),Q_=document.getElementById("speed-label"),ja=document.getElementById("openings-slider"),eg=document.getElementById("openings-label"),Lc=document.getElementById("gen-select"),Uc=document.getElementById("solver-select"),Nl={"binary-tree":new H_,"hunt-and-kill":new k_,prim:new z_,"recursive-backtracker":new V_,"recursive-division":new W_,kruskal:new G_},Fl={astar:new X_,bfs:new Y_,dfs:new q_};let ai=null,Bi=!1,ir="2d";const tg=new K_(ps);let oi=null;const ot={inMaze:new Set,frontier:new Set,open:new Set,closed:new Set,path:[],start:void 0,end:void 0};function Nc(i){return new Promise(e=>setTimeout(e,i))}function Fc(){return Number(Ka.value)}function Oc(){const i=document.getElementById("controls"),e=document.getElementById("legend"),n=document.querySelector("h1").offsetHeight+i.offsetHeight+e.offsetHeight+120,s=Math.min(window.innerWidth-40,window.innerHeight-n);ps.width=s,ps.height=s,as.width=s,as.height=s-200}function cr(i){Dc.disabled=i,Ic.disabled=i,tr.disabled=i,Lc.disabled=i,Uc.disabled=i}function Xi(){ai&&(ir==="2d"?tg.drawMaze(ai,ot):oi.drawMaze(ai,ot))}async function Bc(){var s;if(Bi)return;Bi=!0,cr(!0);const i=Number(nr.value);ai=new jc(i,i),ot.inMaze=new Set,ot.frontier=new Set,ot.open=new Set,ot.closed=new Set,ot.path=[],ot.start={row:0,col:0},ot.end={row:i-1,col:i-1};const e=ai,t=Nl[Lc.value]??Nl.prim;for await(const r of t.generate(e)){if(r.type==="visit"&&(ot.inMaze.add(e.cellKey(r.cell)),ot.frontier.delete(e.cellKey(r.cell)),(s=r.frontier)==null||s.forEach(a=>ot.frontier.add(e.cellKey(a))),Xi()),r.type==="done")break;await Nc(Fc())}ot.frontier.clear();const n=Number(ja.value);if(n>0){const r=[];for(let o=0;o<e.rows;o++)for(let l=0;l<e.cols;l++)l+1<e.cols&&e.hasWall({row:o,col:l},hn)&&r.push([{row:o,col:l},{row:o,col:l+1}]),o+1<e.rows&&e.hasWall({row:o,col:l},cn)&&r.push([{row:o,col:l},{row:o+1,col:l}]);for(let o=r.length-1;o>0;o--){const l=Math.floor(Math.random()*(o+1));[r[o],r[l]]=[r[l],r[o]]}const a=Math.min(n,r.length);for(let o=0;o<a;o++)e.removeWall(r[o][0],r[o][1])}Xi(),Bi=!1,cr(!1)}async function ng(){if(!ai||Bi)return;Bi=!0,cr(!0);const i=ai;ot.open=new Set,ot.closed=new Set,ot.path=[],ot.inMaze=new Set;for(let t=0;t<i.rows;t++)for(let n=0;n<i.cols;n++)ot.inMaze.add(i.cellKey({row:t,col:n}));const e=Fl[Uc.value]??Fl.astar;for await(const t of e.solve(i,ot.start,ot.end)){if(t.type==="open"&&ot.open.add(i.cellKey(t.cell)),t.type==="close"&&(ot.closed.add(i.cellKey(t.cell)),ot.open.delete(i.cellKey(t.cell))),t.type==="path"&&(ot.path=t.path??[]),t.type==="done")break;Xi(),await Nc(Fc())}Xi(),Bi=!1,cr(!1)}nr.addEventListener("input",()=>{J_.textContent=`${nr.value}×${nr.value}`});Ka.addEventListener("input",()=>{Q_.textContent=`${Ka.value} ms`});ja.addEventListener("input",()=>{eg.textContent=`${ja.value}`});Dc.addEventListener("click",Bc);Ic.addEventListener("click",ng);tr.addEventListener("click",()=>{ir==="2d"?(ir="3d",ps.style.display="none",as.style.display="block",tr.textContent="Switch to 2D",oi?oi.resize():oi=new $_(as)):(ir="2d",as.style.display="none",ps.style.display="block",tr.textContent="Switch to 3D"),Xi()});const Zr=document.getElementById("btn-open-cube"),Ol=document.getElementById("main-section"),Bl=document.getElementById("cube-section");let Za=!1,$r=!1;Zr.addEventListener("click",()=>{$r=!$r,$r?(Ol.style.display="none",Bl.style.display="flex",Zr.textContent="2D Maze",Pc(),Za||(Za=!0,B_())):(Bl.style.display="none",Ol.style.display="flex",Zr.textContent="Cube 3D")});window.addEventListener("resize",()=>{Oc(),oi==null||oi.resize(),Xi(),Za&&Pc()});Oc();Bc();
